...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="0" symbologyReferenceScale="-1" version="3.22.7-Białowieża" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" minScale="100000000" simplifyDrawingHints="0" simplifyMaxScale="1">
  <flags>
  ...
  <DiagramLayerSettings priority="0" dist="0" zIndex="0" showAll="1" obstacle="0" placement="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
