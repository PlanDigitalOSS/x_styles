...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="0" symbologyReferenceScale="-1" version="3.22.7-Białowieża" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" simplifyMaxScale="1">
  ...
  <DiagramLayerSettings priority="0" dist="0" zIndex="0" showAll="1" obstacle="0" placement="2" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="abbaugut" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="abbaugut" name="" index="31"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="abbaugut" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="abbaugut" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="abbaugut" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    <field reuseLastValue="0" name="abbaugut"/>
