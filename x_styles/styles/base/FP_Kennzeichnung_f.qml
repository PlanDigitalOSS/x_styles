...
<qgis minScale="100000000" symbologyReferenceScale="-1" maxScale="0" simplifyDrawingTol="1" simplifyLocal="1" version="3.22.7-Białowieża" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyDrawingHints="1" labelsEnabled="0">
  <flags>
  ...
  <temporal startField="" endExpression="" startExpression="" fixedDuration="0" durationUnit="min" endField="" accumulate="0" mode="0" durationField="" enabled="0" limitMode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 enableorderby="0" referencescale="-1" type="RuleRenderer" symbollevels="0" forceraster="0">
    <rules key="{2ace2117-b8d8-45d3-9b37-b3ebe1f42e26}">
      <rule label="Naturgewalten" key="{b23d9672-b994-48b7-8cef-6300e047c22b}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%1000%'" symbol="0"/>
      <rule label="Abbaufläche / Rohstoffvorkommen" key="{d38457f1-49d5-4807-8f30-6a6429fbfe9e}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%2000%'" symbol="1"/>
      <rule label="Gefahr äußerer Einwirkungen" key="{1fdf2e1a-7414-4088-8454-ece89ee8542c}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%3000%'" symbol="2"/>
      <rule label="Schadstoffbelasteter Boden" key="{1904d5f5-1586-4ada-9546-0479a3e44a26}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%4000%'" symbol="3"/>
      <rule label="Lärmbelastung" key="{7d0aa9e7-df88-436d-a6a3-7e67c4922256}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%5000%'" symbol="4"/>
      <rule label="Bergbau" key="{0bb1f9cc-8276-4dc1-8a38-8bd75c476f97}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%6000%'" symbol="5"/>
      <rule label="Flächen für Flurbereinigung" key="{baa336fa-f278-4f8a-91dc-11c4794b8703}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%7000%'" symbol="6"/>
      <rule label="Kennzeichnung nach anderen gesetzlichen Vorschriften" key="{c3a9e2f8-5fc3-459a-8239-be9111ecaca1}" filter="try(array_to_string(&quot;zweckbestimmung&quot;), &quot;zweckbestimmung&quot;) ILIKE  '%9999%'" symbol="7"/>
      <rule label="Sonstige Zweckbestimmung" key="{556e806d-a5af-4300-95d6-64e8fd2a5a74}" filter="ELSE" symbol="8"/>
    </rules>
    <symbols>
      ...
      <symbol name="5" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" class="MarkerLine" pass="0" enabled="1">
          ...
          <symbol name="@5@1" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol name="6" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" class="MarkerLine" pass="0" enabled="1">
          ...
          <symbol name="@6@1" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol name="7" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" class="MarkerLine" pass="0" enabled="1">
          ...
          <symbol name="@7@1" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
      ...
      <symbol name="8" type="fill" force_rhr="0" alpha="1" clip_to_extent="1">
        ...
        <layer locked="0" class="MarkerLine" pass="0" enabled="1">
          ...
          <symbol name="@8@1" type="marker" force_rhr="0" alpha="1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory showAxis="1" penColor="#000000" spacingUnitScale="3x:0,0,0,0,0,0" sizeType="MM" maxScaleDenominator="1e+08" backgroundColor="#ffffff" scaleDependency="Area" barWidth="5" backgroundAlpha="255" width="15" penWidth="0" lineSizeType="MM" diagramOrientation="Up" minScaleDenominator="0" enabled="0" minimumSize="0" opacity="1" rotationOffset="270" penAlpha="255" spacing="5" lineSizeScale="3x:0,0,0,0,0,0" height="15" scaleBasedVisibility="0" direction="0" labelPlacementMethod="XHeight" spacingUnit="MM" sizeScale="3x:0,0,0,0,0,0">
  ...
  <DiagramLayerSettings dist="0" priority="0" showAll="1" zIndex="0" placement="1" linePlacementFlags="18" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="&quot;ebene&quot;" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column name="zweckbestimmung" width="167" type="field" hidden="0"/>
      <column name="text" width="649" type="field" hidden="0"/>
      ...
      <column name="gehoertzubereich_fp_bereich_pkid" width="-1" type="field" hidden="0"/>
