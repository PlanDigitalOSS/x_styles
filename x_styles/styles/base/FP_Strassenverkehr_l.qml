...
<qgis readOnly="0" simplifyMaxScale="1" symbologyReferenceScale="-1" minScale="100000000" version="3.22.7-Białowieża" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" maxScale="0" labelsEnabled="1" styleCategories="AllStyleCategories">
  <flags>
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0" referencescale="-1">
    <rules key="{4ca0cb6c-8aff-44f5-b093-5abf8d2961cb}">
      <rule key="{1f4cff76-174f-423d-9c34-163e60ea64e3}" label="Hauptverkehrsstrasse" filter=" &quot;zweckbestimmung&quot; is '1200'" symbol="0"/>
      <rule key="{51423815-42c7-4a6c-a5c8-3628f69d687f}" label="Wirtschaftsweg" filter=" &quot;zweckbestimmung&quot; is '140012'" symbol="1"/>
      <rule key="{6ed4ba93-064f-4482-871c-8ab00358f69a}" label="Radweg" filter=" &quot;zweckbestimmung&quot; is '14004'" symbol="2"/>
      <rule key="{8e773373-1de3-4bfd-a350-be29f2a573d6}" label="Rad- und Fußweg" filter=" &quot;zweckbestimmung&quot; is '14003'" symbol="3">
        <rule key="{0f024788-a584-415b-abcf-a37b2fa121e4}" label="Radweg" filter=" &quot;zweckbestimmung&quot; is '14004'" symbol="4"/>
      </rule>
      <rule key="{dccd6fb5-0d99-43ea-b2f3-078fc818e69b}" label="Radweg" filter=" &quot;zweckbestimmung&quot; is '14004'" symbol="5">
        <rule key="{d4a333fa-ce14-4176-91e0-59c663945f40}" label="Radweg" filter=" &quot;zweckbestimmung&quot; is '14004'" symbol="6"/>
      </rule>
      <rule key="{02799201-44f9-4317-9135-177cb1b05b45}" label="Fußverbindung" filter=" &quot;zweckbestimmung&quot; is '14005'" symbol="7"/>
      <rule key="{8a036632-55fa-4237-8000-e042280c427e}" label="Hauptwanderweg (Fuss und Rad)" filter=" &quot;zweckbestimmung&quot; is '14006'" symbol="8"/>
      <rule key="{ea2b0532-c239-4f4a-973d-6d70c75f97e2}" label="Reitweg" filter=" &quot;zweckbestimmung&quot; is '14007'" symbol="9"/>
      <rule key="{c6a93033-050c-47a9-826e-5ad2be6e8686}" label="Sonstiger Verkehrsweg oder Anlage." filter="ELSE" symbol="10"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" clip_to_extent="1" force_rhr="0" name="0">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="255,166,0,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
      ...
      <symbol alpha="1" type="line" clip_to_extent="1" force_rhr="0" name="1">
        ...
        <layer enabled="1" pass="0" locked="0" class="SimpleLine">
          <Option type="Map">
            ...
            <Option type="QString" value="0" name="draw_inside_polygon"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="249,228,116,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
            <Option type="QString" value="40" name="line_width"/>
            <Option type="QString" value="MapUnit" name="line_width_unit"/>
            <Option type="QString" value="0" name="offset"/>
          ...
          <prop v="0" k="draw_inside_polygon"/>
          <prop v="bevel" k="joinstyle"/>
          <prop v="249,228,116,255" k="line_color"/>
          <prop v="solid" k="line_style"/>
          <prop v="40" k="line_width"/>
          <prop v="MapUnit" k="line_width_unit"/>
          <prop v="0" k="offset"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontFamily="MS Shell Dlg 2" fontUnderline="0" isExpression="0" useSubstitutions="0" fontSizeUnit="Point" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontWordSpacing="0" fontSize="10" fontWeight="50" blendMode="0" multilineHeight="1" previewBkgrdColor="255,255,255,255" allowHtml="0" namedStyle="Standard" textColor="0,0,0,255" textOrientation="horizontal" capitalization="0" fontLetterSpacing="0" textOpacity="1" fieldName="aufschrift" fontKerning="1" legendString="Aa" fontItalic="0" fontStrikeout="0">
        <families/>
        <text-buffer bufferSizeUnits="MM" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferBlendMode="0" bufferOpacity="1" bufferNoFill="1" bufferSize="1" bufferJoinStyle="128" bufferDraw="0" bufferColor="255,255,255,255"/>
        <text-mask maskOpacity="1" maskType="0" maskJoinStyle="128" maskedSymbolLayers="" maskEnabled="0" maskSizeUnits="MM" maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
        <background shapeBorderWidth="0" shapeRotationType="0" shapeSizeUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeSizeY="0" shapeRotation="0" shapeOpacity="1" shapeFillColor="255,255,255,255" shapeSVGFile="" shapeOffsetUnit="MM" shapeRadiiUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeSizeType="0" shapeSizeX="0" shapeRadiiY="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeDraw="0" shapeOffsetY="0" shapeJoinStyle="64" shapeOffsetX="0" shapeType="0" shapeBlendMode="0" shapeBorderColor="128,128,128,255" shapeBorderWidthUnit="MM" shapeRadiiX="0">
        ...
        <shadow shadowRadius="1.5" shadowOffsetUnit="MM" shadowColor="0,0,0,255" shadowRadiusAlphaOnly="0" shadowOpacity="0.69999999999999996" shadowOffsetDist="1" shadowRadiusUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowUnder="0" shadowScale="100" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1" shadowBlendMode="6" shadowOffsetAngle="135" shadowDraw="0"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <text-format multilineAlign="0" useMaxLineLengthForAutoWrap="1" wrapChar="" formatNumbers="0" reverseDirectionSymbol="0" decimals="3" addDirectionSymbol="0" plussign="0" autoWrapLength="0" leftDirectionSymbol="&lt;" placeDirectionSymbol="0" rightDirectionSymbol=">"/>
      <placement rotationAngle="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleIn="25" geometryGenerator="" xOffset="0" lineAnchorClipping="0" distMapUnitScale="3x:0,0,0,0,0,0" fitInPolygonOnly="0" placementFlags="10" priority="5" lineAnchorPercent="0.5" offsetUnits="MM" quadOffset="4" geometryGeneratorEnabled="0" preserveRotation="1" overrunDistanceUnit="MM" centroidInside="0" lineAnchorType="0" rotationUnit="AngleDegrees" polygonPlacementFlags="2" overrunDistance="0" offsetType="0" distUnits="MM" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" geometryGeneratorType="PointGeometry" repeatDistanceUnits="MM" yOffset="0" dist="0" repeatDistance="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" centroidWhole="0" maxCurvedCharAngleOut="-25" placement="3"/>
      <rendering maxNumLabels="2000" scaleMax="0" obstacleType="1" fontLimitPixelSize="0" obstacleFactor="1" obstacle="1" labelPerPart="0" fontMaxPixelSize="10000" upsidedownLabels="0" minFeatureSize="0" displayAll="0" fontMinPixelSize="3" zIndex="0" mergeLines="0" unplacedVisibility="0" limitNumLabels="0" scaleMin="0" drawLabels="1" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" value="" name="name"/>
          <Option name="properties"/>
  ...
  <attributetableconfig sortOrder="1" sortExpression="&quot;zweckbestimmung&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="315" hidden="0" name="text"/>
