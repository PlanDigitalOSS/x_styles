...
<qgis styleCategories="AllStyleCategories" maxScale="0" simplifyDrawingTol="1" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyDrawingHints="1" version="3.22.7-Białowieża" minScale="100000000" labelsEnabled="0" readOnly="0" simplifyAlgorithm="0" simplifyMaxScale="1">
  <flags>
  ...
  <temporal enabled="0" durationField="" endField="" mode="0" startExpression="" durationUnit="min" endExpression="" limitMode="0" accumulate="0" startField="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer" enableorderby="0" forceraster="0" referencescale="-1">
    <rules key="{da23b62b-8237-4728-87c0-2513aa4ed7a7}">
      <rule filter="try (array_to_string (&quot;gebietstyp&quot;), &quot;gebietstyp&quot;) ILIKE '%1000%'  AND  &quot;rechtscharakter&quot;  = '1000'" symbol="0" label="Vorranggebiet ruhige Erholung in Natur und Landschaft" key="{20daef66-b274-4f4b-9869-f5665eaa26a3}"/>
      <rule filter="ELSE" symbol="1" label="ohne Symbolisierung" key="{4921df0f-cc07-4da4-aa63-dfbfad7a9990}"/>
    </rules>
    <symbols>
      <symbol type="line" alpha="1" clip_to_extent="1" name="0" force_rhr="0">
        ...
        <layer enabled="1" pass="0" class="SimpleLine" locked="0">
          <Option type="Map">
            ...
            <Option value="100,200,0,255" type="QString" name="line_color"/>
          ...
          <prop v="100,200,0,255" k="line_color"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory width="15" minScaleDenominator="0" lineSizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" spacingUnit="MM" backgroundAlpha="255" maxScaleDenominator="1e+08" showAxis="1" enabled="0" scaleBasedVisibility="0" sizeScale="3x:0,0,0,0,0,0" minimumSize="0" sizeType="MM" height="15" penColor="#000000" rotationOffset="270" spacingUnitScale="3x:0,0,0,0,0,0" direction="0" spacing="5" diagramOrientation="Up" backgroundColor="#ffffff" barWidth="5" opacity="1" labelPlacementMethod="XHeight" penWidth="0" penAlpha="255">
  ...
  <DiagramLayerSettings placement="2" zIndex="0" dist="0" linePlacementFlags="18" priority="0" obstacle="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="typerholung" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="typtourismus" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="typerholung" name="" index="34"/>
    <alias field="typtourismus" name="" index="35"/>
    <alias field="besonderertyp" name="" index="36"/>
  </aliases>
  <defaults>
    ...
    <default field="typerholung" applyOnUpdate="0" expression=""/>
    <default field="typtourismus" applyOnUpdate="0" expression=""/>
    <default field="besonderertyp" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" field="istausgleichsgebiet" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="imverbund" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="typerholung" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint exp_strength="0" field="typtourismus" constraints="0" unique_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="istausgleichsgebiet" desc="" exp=""/>
    <constraint field="imverbund" desc="" exp=""/>
    <constraint field="typerholung" desc="" exp=""/>
    <constraint field="typtourismus" desc="" exp=""/>
    <constraint field="besonderertyp" desc="" exp=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column type="field" width="-1" name="gliederung2" hidden="0"/>
      ...
      <column type="field" width="-1" name="istausgleichsgebiet" hidden="0"/>
      <column type="field" width="-1" name="imverbund" hidden="0"/>
      <column type="field" width="-1" name="typerholung" hidden="0"/>
      <column type="field" width="-1" name="typtourismus" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="besonderertyp"/>
    ...
    <field editable="1" name="typerholung"/>
    <field editable="1" name="typtourismus"/>
    <field editable="1" name="uuid"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="aufschrift"/>
    <field labelOnTop="0" name="bedeutsamkeit"/>
    <field labelOnTop="0" name="besonderertyp"/>
    ...
    <field labelOnTop="0" name="typerholung"/>
    <field labelOnTop="0" name="typtourismus"/>
    <field labelOnTop="0" name="uuid"/>
  </labelOnTop>
  <reuseLastValue>
    <field reuseLastValue="0" name="aufschrift"/>
    <field reuseLastValue="0" name="bedeutsamkeit"/>
    <field reuseLastValue="0" name="besonderertyp"/>
    ...
    <field reuseLastValue="0" name="typerholung"/>
    <field reuseLastValue="0" name="typtourismus"/>
