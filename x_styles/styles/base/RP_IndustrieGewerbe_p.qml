...
<qgis simplifyLocal="1" maxScale="0" minScale="100000000" version="3.34.3-Prizren" hasScaleBasedVisibilityFlag="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyDrawingTol="1" symbologyReferenceScale="-1" simplifyDrawingHints="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" readOnly="0">
  <flags>
  ...
  <temporal startField="" startExpression="" mode="0" accumulate="0" limitMode="0" endField="" endExpression="" fixedDuration="0" durationUnit="min" durationField="" enabled="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation respectLayerSymbol="1" zscale="1" extrusion="0" symbology="Line" binding="Centroid" showMarkerSymbolInSurfacePlots="0" zoffset="0" clamping="Terrain" type="IndividualFeatures" extrusionEnabled="0">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="line" name="">
        ...
        <layer locked="0" pass="0" class="SimpleLine" id="{5f202d82-a1c8-4a1a-92c0-3a5d6f07bbb1}" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="fill" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="SimpleFill" id="{14fadf70-6ef3-48ba-8b6f-7347d57427ff}" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="marker" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="SimpleMarker" id="{d3083d2a-4b1f-44b0-baa1-50653eadf93a}" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 referencescale="-1" enableorderby="0" type="RuleRenderer" forceraster="0" symbollevels="0">
    <rules key="{7515022a-8d08-49c8-bee8-fce50cd0fb08}">
      <rule label="01.11 Standort für die Sicherung und Entwicklung von Arbeitsstätten" filter="try (array_to_string (&quot;typ&quot;), &quot;typ&quot;) ILIKE '%4000%'" key="{c441778b-7957-4a16-b682-53e11dc510d6}" symbol="0"/>
      <rule label="Stil fehlt" filter="ELSE" key="{51caa829-6443-4020-8bec-18fc04b07cdf}" symbol="1"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="marker" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="SvgMarker" id="{53048159-066c-4191-93b1-c58f1f8106a4}" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="139,98,77,255" type="QString" name="color"/>
            ...
            <Option value="diameter" type="QString" name="scale_method"/>
            <Option value="400" type="QString" name="size"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="size_map_unit_scale"/>
      ...
      <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="marker" name="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" class="SimpleMarker" id="{2cf34d75-cefb-4e19-9d5c-ddcf979d01d8}" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
        ...
        <layer locked="0" pass="0" class="SimpleMarker" id="{1beebece-a9ef-4a30-a620-4198828bf169}" enabled="1">
          <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="marker" name="">
        ...
        <layer locked="0" pass="0" class="SimpleMarker" id="{758881ef-73ae-4e38-82fc-2194951f51d0}" enabled="1">
          <Option type="Map">
            <Option value="0" type="QString" name="angle"/>
            <Option value="square" type="QString" name="cap_style"/>
            <Option value="255,0,0,255" type="QString" name="color"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory spacing="0" barWidth="5" scaleBasedVisibility="0" width="15" labelPlacementMethod="XHeight" diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0" sizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" spacingUnitScale="3x:0,0,0,0,0,0" penColor="#000000" opacity="1" lineSizeType="MM" penAlpha="255" scaleDependency="Area" minimumSize="0" direction="1" backgroundColor="#ffffff" rotationOffset="270" height="15" minScaleDenominator="0" sizeType="MM" spacingUnit="MM" backgroundAlpha="255" enabled="0" penWidth="0" showAxis="0">
      <fontProperties underline="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" bold="0" italic="0" style=""/>
      ...
      <axisSymbol>
        <symbol frame_rate="10" force_rhr="0" is_animated="0" alpha="1" clip_to_extent="1" type="line" name="">
          ...
          <layer locked="0" pass="0" class="SimpleLine" id="{368235bb-23f5-4266-96dc-6e7f38797ac3}" enabled="1">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <DiagramLayerSettings dist="0" showAll="1" linePlacementFlags="2" obstacle="0" placement="0" zIndex="0" priority="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="bauhoehenbeschraenkung">
      <editWidget type="Range">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="istsiedlungsbeschraenkung">
      <editWidget type="CheckBox">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="bauhoehenbeschraenkung" index="32" name=""/>
    <alias field="istsiedlungsbeschraenkung" index="33" name=""/>
    <alias field="typ" index="34" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="bauhoehenbeschraenkung"/>
    <policy policy="Duplicate" field="istsiedlungsbeschraenkung"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="bauhoehenbeschraenkung" expression=""/>
    <default applyOnUpdate="0" field="istsiedlungsbeschraenkung" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="descriptionreference_href" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="descriptionreference_title" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="descriptionreference_nilreason" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="identifier_codespace" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="identifier" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="uuid" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="text" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="rechtsstand" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gesetzlichegrundlage_codespace" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gesetzlichegrundlage" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gliederung1" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gliederung2" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="ebene" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_owns" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_href" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_title" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_nilreason" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_rp_bereich_pkid" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="startbedingung_pkid" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="endebedingung_pkid" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="aufschrift" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="rechtscharakter" unique_strength="0" notnull_strength="1" exp_strength="0" constraints="1"/>
    <constraint field="konkretisierung" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="gebietstyp" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="kuestenmeer" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="bedeutsamkeit" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="istzweckbindung" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="flaechenschluss" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="flussrichtung" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="bauhoehenbeschraenkung" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="istsiedlungsbeschraenkung" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
    <constraint field="typ" unique_strength="0" notnull_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint field="bauhoehenbeschraenkung" exp="" desc=""/>
    <constraint field="istsiedlungsbeschraenkung" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column hidden="0" type="field" name="gliederung2" width="1097"/>
      <column hidden="0" type="field" name="rechtscharakter" width="-1"/>
      <column hidden="0" type="field" name="typ" width="-1"/>
      ...
      <column hidden="0" type="field" name="gehoertzubereich_rp_bereich_pkid" width="-1"/>
      ...
      <column hidden="0" type="field" name="konkretisierung" width="-1"/>
      <column hidden="0" type="field" name="gebietstyp" width="-1"/>
      <column hidden="0" type="field" name="kuestenmeer" width="-1"/>
      <column hidden="0" type="field" name="bedeutsamkeit" width="-1"/>
      <column hidden="0" type="field" name="istzweckbindung" width="-1"/>
      <column hidden="0" type="field" name="flaechenschluss" width="-1"/>
      <column hidden="0" type="field" name="flussrichtung" width="-1"/>
      <column hidden="0" type="field" name="bauhoehenbeschraenkung" width="-1"/>
      <column hidden="0" type="field" name="istsiedlungsbeschraenkung" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="bauhoehenbeschraenkung"/>
    ...
    <field editable="1" name="istsiedlungsbeschraenkung"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="bauhoehenbeschraenkung"/>
    ...
    <field labelOnTop="0" name="istsiedlungsbeschraenkung"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="bauhoehenbeschraenkung"/>
    ...
    <field reuseLastValue="0" name="istsiedlungsbeschraenkung"/>
