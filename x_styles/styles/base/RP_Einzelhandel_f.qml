...
<qgis minScale="100000000" simplifyMaxScale="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories" simplifyLocal="1" labelsEnabled="0" simplifyAlgorithm="0" version="3.22.7-Białowieża" simplifyDrawingHints="1" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" maxScale="0" readOnly="0">
  <flags>
  ...
  <temporal startField="" mode="0" startExpression="" fixedDuration="0" durationField="" limitMode="0" accumulate="0" endField="" endExpression="" enabled="0" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0" forceraster="0">
    <rules key="{70005002-0a7b-4c09-9de7-8fc9f94d4573}">
      <rule label="Solitär gelegener Einzelhandelsstandort" key="{36a5167d-1e85-4313-ae65-d9b93864c169}" symbol="0" filter="try (array_to_string(&quot;typ&quot;), &quot;typ&quot;) ILIKE  '%1000%'"/>
      <rule label="Regional bedeutsamer Fachmarktstandort" key="{6cb9bbc7-b337-4b98-98da-547c7a4cb53d}" symbol="1" filter="try (array_to_string(&quot;typ&quot;), &quot;typ&quot;) ILIKE  '%7000%'"/>
      <rule key="{1f4eed3f-7dc2-4a7f-8ee5-3b581aabe7cb}" symbol="2" filter="ELSE">
        <rule label="Fachmarktzentrum" key="{46e733af-5c98-47bd-aa07-26b12e8d3936}" symbol="3" filter="ELSE"/>
      </rule>
    </rules>
    <symbols>
      <symbol force_rhr="0" name="0" type="fill" clip_to_extent="1" alpha="1">
        ...
        <layer class="LinePatternFill" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option value="249,176,0,255" name="color" type="QString"/>
            <Option value="75" name="distance" type="QString"/>
          ...
          <prop k="angle" v="135"/>
          <prop k="color" v="249,176,0,255"/>
          <prop k="distance" v="75"/>
          ...
          <symbol force_rhr="0" name="@0@0" type="line" clip_to_extent="1" alpha="1">
            ...
            <layer class="SimpleLine" pass="0" locked="0" enabled="1">
              <Option type="Map">
                ...
                <Option value="249,176,0,255" name="line_color" type="QString"/>
              ...
              <prop k="line_color" v="249,176,0,255"/>
        ...
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="offset_unit" type="QString"/>
            <Option value="249,176,0,255" name="outline_color" type="QString"/>
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="249,176,0,255"/>
      ...
      <symbol force_rhr="0" name="1" type="fill" clip_to_extent="1" alpha="1">
          ...
          <symbol force_rhr="0" name="@1@0" type="line" clip_to_extent="1" alpha="1">
            ...
            <layer class="SimpleLine" pass="0" locked="0" enabled="1">
              <Option type="Map">
                ...
                <Option value="0" name="draw_inside_polygon" type="QString"/>
                <Option value="bevel" name="joinstyle" type="QString"/>
                <Option value="0,97,173,255" name="line_color" type="QString"/>
                <Option value="solid" name="line_style" type="QString"/>
                <Option value="30" name="line_width" type="QString"/>
                <Option value="MapUnit" name="line_width_unit" type="QString"/>
                <Option value="0" name="offset" type="QString"/>
              ...
              <prop k="draw_inside_polygon" v="0"/>
              <prop k="joinstyle" v="bevel"/>
              <prop k="line_color" v="0,97,173,255"/>
              <prop k="line_style" v="solid"/>
              <prop k="line_width" v="30"/>
              <prop k="line_width_unit" v="MapUnit"/>
              <prop k="offset" v="0"/>
        ...
        <layer class="SimpleFill" pass="0" locked="0" enabled="1">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
            <Option value="MapUnit" name="offset_unit" type="QString"/>
            <Option value="0,97,173,255" name="outline_color" type="QString"/>
            <Option value="solid" name="outline_style" type="QString"/>
            <Option value="20" name="outline_width" type="QString"/>
            <Option value="MapUnit" name="outline_width_unit" type="QString"/>
            <Option value="no" name="style" type="QString"/>
          ...
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="0,97,173,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="20"/>
          <prop k="outline_width_unit" v="MapUnit"/>
          <prop k="style" v="no"/>
      ...
      <symbol force_rhr="0" name="2" type="fill" clip_to_extent="1" alpha="1">
        ...
        <layer class="PointPatternFill" pass="0" locked="0" enabled="1">
          ...
          <symbol force_rhr="0" name="@2@1" type="marker" clip_to_extent="1" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory opacity="1" penAlpha="255" showAxis="1" labelPlacementMethod="XHeight" spacingUnitScale="3x:0,0,0,0,0,0" lineSizeScale="3x:0,0,0,0,0,0" penWidth="0" backgroundColor="#ffffff" diagramOrientation="Up" minScaleDenominator="0" scaleBasedVisibility="0" barWidth="5" backgroundAlpha="255" enabled="0" maxScaleDenominator="1e+08" spacingUnit="MM" rotationOffset="270" height="15" minimumSize="0" scaleDependency="Area" spacing="5" sizeScale="3x:0,0,0,0,0,0" penColor="#000000" lineSizeType="MM" direction="0" sizeType="MM" width="15">
  ...
  <DiagramLayerSettings zIndex="0" showAll="1" linePlacementFlags="18" priority="0" obstacle="0" placement="1" dist="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" index="32" field="bauhoehenbeschraenkung"/>
    <alias name="" index="33" field="istsiedlungsbeschraenkung"/>
    <alias name="" index="34" field="typ"/>
  </aliases>
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="bauhoehenbeschraenkung"/>
    <default expression="" applyOnUpdate="0" field="istsiedlungsbeschraenkung"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="bauhoehenbeschraenkung"/>
    <constraint exp="" desc="" field="istsiedlungsbeschraenkung"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="1" sortExpression="&quot;rechtscharakter&quot;">
    <columns>
      ...
      <column width="696" name="text" hidden="0" type="field"/>
      ...
      <column width="333" name="gliederung1" hidden="0" type="field"/>
      <column width="230" name="gliederung2" hidden="0" type="field"/>
      ...
      <column width="-1" name="bauhoehenbeschraenkung" hidden="0" type="field"/>
      <column width="-1" name="istsiedlungsbeschraenkung" hidden="0" type="field"/>
