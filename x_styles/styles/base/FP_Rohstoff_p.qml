...
<qgis version="3.16.8-Hannover" maxScale="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="0" readOnly="0" minScale="100000000" labelsEnabled="0">
  <flags>
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{26038187-fe72-4095-a11c-91cdcb27e2b9}">
      <rule symbol="0" label="Torf" key="{517583b4-ec47-4b5d-9e99-dca6e24ca7bd}" filter="&quot;rohstofftyp&quot; ILIKE '%6700%'"/>
      <rule symbol="1" label="Fehlende Regel für Rohstofftyp" key="{0a7adcd4-c669-4745-9a05-4018744ed06b}" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol name="0" type="marker" alpha="1" force_rhr="0" clip_to_extent="1">
        <layer enabled="1" pass="0" locked="0" class="SvgMarker">
          <prop v="0" k="angle"/>
          <prop v="250,185,81,255" k="color"/>
          <prop v="0" k="fixedAspectRatio"/>
          <prop v="1" k="horizontal_anchor_point"/>
          <prop v="RP/RP_S_Rohstoff_T_vb_Nds.svg" k="name"/>
          <prop v="0,0" k="offset"/>
  ...
  <customproperties>
    <property value="&quot;descriptionreference_title&quot;" key="dualview/previewExpressions"/>
  ...
  <DiagramLayerSettings priority="0" dist="0" obstacle="0" showAll="1" placement="0" linePlacementFlags="18" zIndex="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column name="tiefe" type="field" hidden="0" width="-1"/>
