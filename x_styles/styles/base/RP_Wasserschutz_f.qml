...
<qgis labelsEnabled="0" simplifyDrawingTol="1" simplifyLocal="1" minScale="100000000" readOnly="0" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingHints="1" version="3.22.8-Białowieża" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" maxScale="0" symbologyReferenceScale="-1">
  <flags>
  ...
  <temporal enabled="0" accumulate="0" durationField="" durationUnit="min" mode="0" endExpression="" fixedDuration="0" limitMode="0" endField="" startExpression="" startField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <renderer-v2 type="RuleRenderer" referencescale="-1" forceraster="0" symbollevels="1" enableorderby="0">
    <rules key="{9d655726-a967-490e-a9f5-28aed6a25410}">
      <rule filter="try (array_to_string (&quot;gebietstyp&quot;), &quot;gebietstyp&quot;) ILIKE '%1000%'" label="11.01 VR für Trinkwassergewinnung" symbol="0" key="{0f47856f-32fb-4640-98a0-86ea55960cbb}"/>
      <rule filter=" try (array_to_string (&quot;gebietstyp&quot;), &quot;gebietstyp&quot;) ILIKE '%1100%' And try(array_to_string (&quot;typ&quot;), &quot;typ&quot;) ILIKE '%4000%'" label="11.2 Vb für Trinkwassergewinnung" symbol="1" key="{8f0e8f77-1b58-43fe-ba04-c2a4e2922729}"/>
      <rule filter="try (array_to_string (&quot;gebietstyp&quot;), &quot;gebietstyp&quot;) ILIKE '%1500%'" label="11.2 Vorsorgegebiet für Trinkwassergewinnung (alt)" symbol="2" key="{ec72ad54-9de9-4db2-97de-56c2e06a63ce}">
        <rule filter="  &quot;gebietsTyp&quot;  =  1100 And &quot;typ&quot;  =  4000 " label="11.2 Vb für Trinkwassergewinnung" symbol="3" key="{5d95b153-743e-4fed-991c-592d777868bd}"/>
      </rule>
      <rule filter="ELSE" label="Stil fehlt" symbol="4" key="{2a11ec3a-be26-45d5-a4e8-be77c43de5dd}"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="fill" name="1" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option type="QString" value="80" name="interval"/>
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@1@4" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
      ...
      <symbol clip_to_extent="1" force_rhr="0" type="fill" name="2" alpha="1">
        ...
        <layer enabled="1" class="MarkerLine" locked="0" pass="0">
          ...
          <symbol clip_to_extent="1" force_rhr="0" type="marker" name="@2@4" alpha="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory spacingUnit="MM" scaleDependency="Area" sizeType="MM" showAxis="0" lineSizeScale="3x:0,0,0,0,0,0" width="15" opacity="1" maxScaleDenominator="1e+08" penColor="#000000" direction="1" labelPlacementMethod="XHeight" spacingUnitScale="3x:0,0,0,0,0,0" backgroundAlpha="255" penAlpha="255" sizeScale="3x:0,0,0,0,0,0" penWidth="0" diagramOrientation="Up" barWidth="5" height="15" rotationOffset="270" backgroundColor="#ffffff" minScaleDenominator="0" lineSizeType="MM" enabled="0" scaleBasedVisibility="0" spacing="0" minimumSize="0">
  ...
  <DiagramLayerSettings showAll="1" obstacle="0" zIndex="0" priority="0" dist="0" linePlacementFlags="18" placement="1">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias field="istausgleichsgebiet" index="32" name=""/>
    <alias field="imverbund" index="33" name=""/>
    <alias field="typ" index="34" name=""/>
    <alias field="zone" index="35" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="description" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="descriptionreference_href" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="descriptionreference_title" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="descriptionreference_nilreason" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="identifier_codespace" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="identifier" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="uuid" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="text" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="rechtsstand" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gesetzlichegrundlage_codespace" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gesetzlichegrundlage" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gliederung1" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gliederung2" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="ebene" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gehoertzubereich_owns" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gehoertzubereich_href" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gehoertzubereich_title" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gehoertzubereich_nilreason" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gehoertzubereich_rp_bereich_pkid" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="startbedingung_pkid" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="endebedingung_pkid" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="aufschrift" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="rechtscharakter" notnull_strength="1" exp_strength="0" constraints="1" unique_strength="0"/>
    <constraint field="konkretisierung" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="gebietstyp" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="kuestenmeer" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="bedeutsamkeit" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="istzweckbindung" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="flaechenschluss" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="flussrichtung" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="istausgleichsgebiet" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="imverbund" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="typ" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
    <constraint field="zone" notnull_strength="0" exp_strength="0" constraints="0" unique_strength="0"/>
  </constraints>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column width="324" type="field" name="gliederung2" hidden="0"/>
