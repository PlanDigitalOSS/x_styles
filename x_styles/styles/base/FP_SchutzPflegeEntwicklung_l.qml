...
<qgis version="3.16.8-Hannover" maxScale="0" simplifyDrawingTol="1" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyMaxScale="1" simplifyLocal="1" simplifyDrawingHints="1" readOnly="0" minScale="100000000" labelsEnabled="0">
  ...
  <renderer-v2 forceraster="0" type="RuleRenderer" enableorderby="0" symbollevels="0">
    <rules key="{4be65ae8-8c02-4513-8953-83a40e847009}">
      <rule symbol="0" label="Suchraum Für Flächen für Ausgleichs- und Ersatzmaßnahmen -lineare Strukturen-" key="{c65fbb07-100f-47d9-9502-9209900e633a}" filter=" &quot;ziel&quot; ilike '%9999%'"/>
      <rule symbol="1" label="fehlend" key="{5582d318-a152-4277-b344-40c7cf3278b4}" filter="ELSE"/>
    </rules>
    <symbols>
  ...
  <aliases>
    ...
    <alias field="ziel" name="" index="31"/>
    <alias field="sonstziel" name="" index="32"/>
    <alias field="istausgleich" name="" index="33"/>
  </aliases>
  <defaults>
    ...
    <default field="ziel" applyOnUpdate="0" expression=""/>
    <default field="sonstziel" applyOnUpdate="0" expression=""/>
    <default field="istausgleich" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint field="ziel" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="sonstziel" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0"/>
    <constraint field="istausgleich" exp_strength="0" constraints="0" unique_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="ziel" exp=""/>
    <constraint desc="" field="sonstziel" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;ziel&quot;" sortOrder="1">
    <columns>
      <column name="text" type="field" hidden="0" width="570"/>
      ...
      <column name="ziel" type="field" hidden="0" width="-1"/>
      ...
      <column name="sonstziel" type="field" hidden="0" width="-1"/>
      <column name="istausgleich" type="field" hidden="0" width="-1"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="sonstziel" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="sonstziel"/>
