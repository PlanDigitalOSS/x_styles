...
<qgis hasScaleBasedVisibilityFlag="0" version="3.22.7-Białowieża" simplifyAlgorithm="0" labelsEnabled="0" simplifyDrawingHints="1" minScale="100000000" simplifyMaxScale="1" styleCategories="AllStyleCategories" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" symbologyReferenceScale="-1" readOnly="0">
  ...
  <renderer-v2 attr="aufschrift" forceraster="0" enableorderby="0" referencescale="-1" type="categorizedSymbol" symbollevels="0">
    <categories>
      <category render="true" symbol="0" label="Aufschüttung" value=""/>
    </categories>
    <symbols>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="aufschuettungsmaterial">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" index="31" field="aufschuettungsmaterial"/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" constraints="0" field="aufschuettungsmaterial" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" field="aufschuettungsmaterial" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" width="-1" name="aufschuettungsmaterial" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="aufschuettungsmaterial"/>
