...
<qgis autoRefreshMode="Disabled" symbologyReferenceScale="-1" readOnly="0" autoRefreshTime="0" minScale="100000000" simplifyDrawingHints="1" simplifyAlgorithm="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" version="3.34.13-Prizren" labelsEnabled="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" simplifyMaxScale="1">
  <flags>
  ...
  <temporal startField="" accumulate="0" endExpression="" limitMode="0" enabled="0" startExpression="" endField="" durationField="fid" fixedDuration="0" mode="0" durationUnit="min">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation showMarkerSymbolInSurfacePlots="0" symbology="Line" extrusionEnabled="0" zscale="1" type="IndividualFeatures" binding="Centroid" respectLayerSymbol="1" zoffset="0" extrusion="0" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol frame_rate="10" type="line" name="" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        ...
        <layer locked="0" pass="0" id="{f96f3f30-4465-41ba-9da4-c9c3b3204b59}" enabled="1" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol frame_rate="10" type="fill" name="" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{b5341229-a0eb-46e0-a976-18d0873a23f4}" enabled="1" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol frame_rate="10" type="marker" name="" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{650a44f3-a531-4159-8396-37121d6f52e9}" enabled="1" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" referencescale="-1" symbollevels="0">
    <rules key="{a186d300-44ab-44c2-8179-95635346c7ab}">
      <rule key="{fd337be9-edff-4b3b-9db7-cda1770c8f95}" filter="try (array_to_string (&quot;rechtscharakter&quot;), &quot;rechtscharakter&quot;) ILIKE '%1000%' AND try (array_to_string (&quot;typ&quot;), &quot;typ&quot;) ILIKE '%2000%'" label="8.1 Vorranggebiet Siedlungsbeschränkungsbereich" symbol="0"/>
      <rule key="{73e76438-17ea-439d-a6c0-eacb8408f1de}" filter="try (array_to_string (&quot;rechtscharakter&quot;), &quot;rechtscharakter&quot;) ILIKE '%2000%' AND try (array_to_string (&quot;typ&quot;), &quot;typ&quot;) ILIKE '%1000%'" label="8.2 Vorbehaltsgebiet Lärmbereich" symbol="1"/>
      <rule key="{0d0253ac-f88f-4a4c-a8eb-21b76df7e1e9}" filter="try (array_to_string (&quot;rechtscharakter&quot;), &quot;rechtscharakter&quot;) ILIKE '%4000%' AND try (array_to_string (&quot;typ&quot;), &quot;typ&quot;) ILIKE '%2000%'" label="nachrichtliche Übernahme Siedlungsbeschränkungsbereich" symbol="2"/>
      <rule key="{594cd37a-b0bf-41b6-b897-07ab6358935e}" filter="try (array_to_string (&quot;rechtscharakter&quot;), &quot;rechtscharakter&quot;) ILIKE '%3000%' AND try (array_to_string (&quot;typ&quot;), &quot;typ&quot;) ILIKE '%1000%'" label="nachrichtliche Übernahme Lärmbereich" symbol="3"/>
      <rule key="{088d35e7-cc7c-4fba-a2d3-43e1d7b2484b}" filter="ELSE" label="sonst" symbol="4"/>
    </rules>
    <symbols>
      <symbol frame_rate="10" type="fill" name="0" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{a690d430-1bf8-4dd1-a7de-dd4fb84d9442}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer locked="0" pass="0" id="{77a89764-e79d-4ea5-b7c0-a46ae24800de}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="179,153,255,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
            <Option type="QString" value="200" name="line_width"/>
            <Option type="QString" value="MapUnit" name="line_width_unit"/>
            <Option type="QString" value="0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
      ...
      <symbol frame_rate="10" type="fill" name="1" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{24709790-75f9-440f-b9b4-a88e258c7c5b}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="179,153,255,255" name="line_color"/>
            <Option type="QString" value="solid" name="line_style"/>
            <Option type="QString" value="60" name="line_width"/>
            <Option type="QString" value="MapUnit" name="line_width_unit"/>
            <Option type="QString" value="60" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MapUnit" name="offset_unit"/>
            <Option type="QString" value="0" name="ring_filter"/>
            <Option type="QString" value="0" name="trim_distance_end"/>
        ...
        <layer locked="0" pass="0" id="{253361ca-10ca-4702-a263-4a20e055771a}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
        ...
        <layer locked="0" pass="0" id="{a5572eed-46aa-4270-ba73-e05ae2e789ee}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="MapUnit" name="line_width_unit"/>
            <Option type="QString" value="25" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MapUnit" name="offset_unit"/>
            <Option type="QString" value="0" name="ring_filter"/>
            <Option type="QString" value="0" name="trim_distance_end"/>
        ...
        <layer locked="0" pass="0" id="{a0264535-2328-46b3-9290-f3ca052748b7}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="MapUnit" name="line_width_unit"/>
            <Option type="QString" value="10" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MapUnit" name="offset_unit"/>
            <Option type="QString" value="0" name="ring_filter"/>
            <Option type="QString" value="0" name="trim_distance_end"/>
        ...
        <layer locked="0" pass="1" id="{b711d9fd-b0dc-46fb-b38d-91a31f8d456b}" enabled="1" class="SimpleFill">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
      ...
      <symbol frame_rate="10" type="fill" name="2" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" type="fill" name="3" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
      ...
      <symbol frame_rate="10" type="fill" name="4" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option type="QString" value="" name="name"/>
            <Option name="properties"/>
        ...
        <layer locked="0" pass="0" id="{ddb4ff37-4136-4925-aa79-6301801d6b6d}" enabled="1" class="SimpleFill">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
        ...
        <layer locked="0" pass="0" id="{34561391-1804-4324-80a6-b8bf80c31ae5}" enabled="1" class="PointPatternFill">
          <Option type="Map">
            ...
            <Option type="QString" value="22483723" name="seed"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option type="QString" value="" name="name"/>
          ...
          <symbol frame_rate="10" type="marker" name="@4@1" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" pass="0" id="{9587a362-b83e-4501-8cdb-3944d93fe7ee}" enabled="1" class="SimpleMarker">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
        ...
        <layer locked="0" pass="0" id="{10fbea32-7e2c-455c-8f4e-0e8a21872895}" enabled="1" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol frame_rate="10" type="fill" name="" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
        ...
        <layer locked="0" pass="0" id="{e61330e5-836b-47e1-8d01-3c6600decf35}" enabled="1" class="SimpleFill">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="0,0,255,255" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory maxScaleDenominator="1e+08" spacingUnit="MM" diagramOrientation="Up" spacingUnitScale="3x:0,0,0,0,0,0" lineSizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" minScaleDenominator="0" penColor="#000000" sizeType="MM" backgroundColor="#ffffff" barWidth="5" height="15" penWidth="0" penAlpha="255" rotationOffset="270" scaleDependency="Area" direction="0" sizeScale="3x:0,0,0,0,0,0" minimumSize="0" spacing="5" backgroundAlpha="255" width="15" enabled="0" opacity="1" labelPlacementMethod="XHeight" showAxis="1">
      <fontProperties underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" strikethrough="0" style="" italic="0" bold="0"/>
      ...
      <axisSymbol>
        <symbol frame_rate="10" type="line" name="" clip_to_extent="1" is_animated="0" alpha="1" force_rhr="0">
          ...
          <layer locked="0" pass="0" id="{ecd80032-505b-4289-a3a2-9e8be5034190}" enabled="1" class="SimpleLine">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <DiagramLayerSettings zIndex="0" priority="0" obstacle="0" dist="0" showAll="1" placement="1" linePlacementFlags="2">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <attributetableconfig sortExpression="&quot;typ&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      ...
      <column type="field" hidden="0" name="descriptionreference_href" width="-1"/>
      <column type="field" hidden="0" name="descriptionreference_title" width="-1"/>
      <column type="field" hidden="0" name="descriptionreference_nilreason" width="-1"/>
      <column type="field" hidden="0" name="identifier_codespace" width="-1"/>
      <column type="field" hidden="0" name="identifier" width="-1"/>
      <column type="field" hidden="0" name="uuid" width="-1"/>
      <column type="field" hidden="0" name="text" width="-1"/>
      <column type="field" hidden="0" name="rechtsstand" width="-1"/>
      <column type="field" hidden="0" name="gesetzlichegrundlage_codespace" width="-1"/>
      <column type="field" hidden="0" name="gesetzlichegrundlage" width="-1"/>
      <column type="field" hidden="0" name="gliederung1" width="-1"/>
      <column type="field" hidden="0" name="gliederung2" width="444"/>
      <column type="field" hidden="0" name="ebene" width="-1"/>
      <column type="field" hidden="0" name="gehoertzubereich_owns" width="-1"/>
      <column type="field" hidden="0" name="gehoertzubereich_href" width="-1"/>
      <column type="field" hidden="0" name="gehoertzubereich_title" width="-1"/>
      <column type="field" hidden="0" name="gehoertzubereich_nilreason" width="-1"/>
      <column type="field" hidden="0" name="gehoertzubereich_rp_bereich_pkid" width="-1"/>
      <column type="field" hidden="0" name="startbedingung_pkid" width="-1"/>
      <column type="field" hidden="0" name="endebedingung_pkid" width="-1"/>
      <column type="field" hidden="0" name="aufschrift" width="-1"/>
      <column type="field" hidden="0" name="rechtscharakter" width="-1"/>
      <column type="field" hidden="0" name="konkretisierung" width="-1"/>
      <column type="field" hidden="0" name="gebietstyp" width="-1"/>
      <column type="field" hidden="0" name="kuestenmeer" width="38"/>
      <column type="field" hidden="0" name="bedeutsamkeit" width="37"/>
      <column type="field" hidden="0" name="istzweckbindung" width="29"/>
      <column type="field" hidden="0" name="flaechenschluss" width="39"/>
      <column type="field" hidden="0" name="flussrichtung" width="31"/>
