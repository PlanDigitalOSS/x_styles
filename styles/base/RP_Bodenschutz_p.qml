...
<qgis minScale="100000000" simplifyDrawingTol="1" maxScale="0" readOnly="0" version="3.22.7-Białowieża" simplifyMaxScale="1" labelsEnabled="0" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyAlgorithm="0" simplifyLocal="1" symbologyReferenceScale="-1" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{f72b25ce-741c-41fc-8e79-5631a8fb291f}">
      <rule filter="(typ = 1000 or typ=2000) AND try (array_to_string (&quot;gebietstyp&quot;), &quot;gebietstyp&quot;) ILIKE '%1000%'" key="{d14e61e7-c4bb-4c04-83a0-a1b9c6887807}" symbol="0" label="06.01 Vorranggebiet Sicherung oder Sanierung erheblicher Bodenbelastung / Altlasten"/>
      <rule filter="ELSE" key="{be4efbba-038b-428b-8be9-a4ee1383240d}" symbol="1" description="Stil fehlt" label="Stil fehlt"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" type="marker" clip_to_extent="1" name="0" alpha="1">
        ...
        <layer locked="0" class="SvgMarker" pass="0" enabled="1">
          <Option type="Map">
            ...
            <Option type="QString" value="0,-20.00000000000000355" name="offset"/>
          ...
          <prop k="offset" v="0,-20.00000000000000355"/>
