...
<qgis version="3.34.13-Prizren" minScale="100000000" labelsEnabled="0" simplifyAlgorithm="0" autoRefreshTime="0" autoRefreshMode="Disabled" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" simplifyDrawingHints="0" maxScale="0" readOnly="0" simplifyMaxScale="1" simplifyDrawingTol="1">
  <flags>
  ...
  <elevation clamping="Terrain" symbology="Line" showMarkerSymbolInSurfacePlots="0" binding="Centroid" zscale="1" extrusion="0" respectLayerSymbol="1" type="IndividualFeatures" extrusionEnabled="0" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{ed86bcb1-1d1b-443f-8442-c75f3a49ee59}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="fill" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{c1f6931b-c1f1-4b2c-b832-fc0e563e1a66}" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="marker" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{73a3159d-6af0-4ea9-a330-3ae5842bc766}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" type="singleSymbol" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="marker" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{048999fc-63ba-49c3-94d8-cc0dd00d133e}" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="marker" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{f22854e0-2f4e-45e4-a6f8-9f1f3ed8660f}" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" value="0" type="QString"/>
            <Option name="cap_style" value="square" type="QString"/>
    ...
    <DiagramCategory penColor="#000000" enabled="0" spacingUnit="MM" minimumSize="0" rotationOffset="270" maxScaleDenominator="1e+08" penAlpha="255" spacing="5" barWidth="5" backgroundAlpha="255" height="15" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" spacingUnitScale="3x:0,0,0,0,0,0" sizeType="MM" scaleDependency="Area" penWidth="0" minScaleDenominator="0" backgroundColor="#ffffff" showAxis="1" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" opacity="1" width="15" lineSizeType="MM" direction="0" scaleBasedVisibility="0">
      ...
      <axisSymbol>
        <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" frame_rate="10">
          ...
          <layer enabled="1" pass="0" locked="0" id="{e6868cb1-c53a-4d5f-8caa-e9bfccdb0b11}" class="SimpleLine">
            <Option type="Map">
              <Option name="align_dash_pattern" value="0" type="QString"/>
              <Option name="capstyle" value="square" type="QString"/>
              <Option name="customdash" value="5;2" type="QString"/>
  ...
  <DiagramLayerSettings priority="0" obstacle="0" dist="0" placement="0" zIndex="0" linePlacementFlags="18" showAll="1">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" field="xplan_name" index="34"/>
    <alias name="" field="nummer" index="35"/>
  </aliases>
  <splitPolicies>
