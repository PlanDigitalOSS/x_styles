...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" version="3.22.7-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" maxScale="0">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{3e852b59-4c8c-481b-aeeb-7c3e07723295}">
      <rule filter=" &quot;typ&quot; = '1000' " key="{9c7f558e-2147-46a3-9338-b492f0a35264}" symbol="0" label="Bundesgrenze"/>
      <rule filter=" &quot;typ&quot; = '1100' " key="{fdc6d033-0b78-41f6-8335-f3901c361b3f}" symbol="1" label="Landesgrenze"/>
      <rule filter=" &quot;typ&quot; = '1550' " key="{a487153f-03d8-4582-85fc-2cc72a2004c0}" symbol="2" label="Amtsgrenze"/>
      <rule filter=" &quot;typ&quot; = '1300' " key="{6ddf25dd-673e-41b4-827e-c5a43741f700}" symbol="3" label="Kreisgrenze"/>
      <rule filter=" &quot;typ&quot; = '1400' " key="{8a242e43-a251-4607-8993-2f66d56c47cc}" symbol="4" label="Gemeindegrenze"/>
      <rule filter=" &quot;typ&quot; = '1600' " key="{deb211a0-3c0a-49d2-a141-168b97092f42}" symbol="5" label="Stadtteilgrenze"/>
      <rule filter=" &quot;typ&quot; = '1500'" key="{e25e3737-2dc7-4eda-b6e0-011534cbc533}" symbol="6" label="Grenze Samtgemeinde"/>
      <rule filter=" &quot;typ&quot; = '1450' " key="{8e87415a-6e38-468f-b74a-86b73d7caa6d}" symbol="7" label="Grenze Mitgliedsgemeinde"/>
      <rule filter="ELSE" key="{b2f3c670-4ce3-4873-847b-da77419ca5d2}" symbol="8" label="sonstige Grenze"/>
      <rule filter="ELSE" checkstate="0" key="{7c9b1cc7-c7d1-44d9-b703-9f981fe326b6}" symbol="9" label="fehlend"/>
    </rules>
    <symbols>
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="line" name="2">
        ...
        <layer class="SimpleLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="3x:0,0,0,0,0,0" type="QString" name="customdash_map_unit_scale"/>
            <Option value="MapUnit" type="QString" name="customdash_unit"/>
            <Option value="1.5" type="QString" name="dash_pattern_offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="dash_pattern_offset_map_unit_scale"/>
            <Option value="MM" type="QString" name="dash_pattern_offset_unit"/>
            <Option value="0" type="QString" name="draw_inside_polygon"/>
          ...
          <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="customdash_unit" v="MapUnit"/>
          <prop k="dash_pattern_offset" v="1.5"/>
          <prop k="dash_pattern_offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="dash_pattern_offset_unit" v="MM"/>
          <prop k="draw_inside_polygon" v="0"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="sonsttyp">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="sonsttyp_id">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="sonsttyp_text">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="typ_text">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="gehoertzubereich" index="9" name=""/>
    <alias field="gesetzlichegrundlage" index="10" name=""/>
    <alias field="gesetzlichegrundlage_id" index="11" name=""/>
    <alias field="gesetzlichegrundlage_text" index="12" name=""/>
    <alias field="gliederung1" index="13" name=""/>
    <alias field="gliederung2" index="14" name=""/>
    <alias field="gml_id" index="15" name=""/>
    <alias field="hatgenerattribut" index="16" name=""/>
    <alias field="hatgenerattribut_dt" index="17" name=""/>
    <alias field="hoehenangabe" index="18" name=""/>
    <alias field="hoehenangabe_dt" index="19" name=""/>
    <alias field="konvertierung_id" index="20" name=""/>
    <alias field="rechtscharakter" index="21" name=""/>
    <alias field="rechtscharakter_text" index="22" name=""/>
    <alias field="rechtsstand" index="23" name=""/>
    <alias field="rechtsstand_text" index="24" name=""/>
    <alias field="refbegruendunginhalt" index="25" name=""/>
    <alias field="reftextinhalt" index="26" name=""/>
    <alias field="sonstrechtscharakter" index="27" name=""/>
    <alias field="sonstrechtscharakter_id" index="28" name=""/>
    <alias field="sonstrechtscharakter_text" index="29" name=""/>
    <alias field="sonsttyp" index="30" name=""/>
    <alias field="sonsttyp_id" index="31" name=""/>
    <alias field="sonsttyp_text" index="32" name=""/>
    <alias field="startbedingung" index="33" name=""/>
    <alias field="startbedingung_dt" index="34" name=""/>
    <alias field="text" index="35" name=""/>
    <alias field="typ" index="36" name=""/>
    <alias field="typ_text" index="37" name=""/>
    <alias field="updated_at" index="38" name=""/>
    <alias field="user_id" index="39" name=""/>
    <alias field="uuid" index="40" name=""/>
    <alias field="wirddargestelltdurch" index="41" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="sonsttyp" expression="" applyOnUpdate="0"/>
    <default field="sonsttyp_id" expression="" applyOnUpdate="0"/>
    <default field="sonsttyp_text" expression="" applyOnUpdate="0"/>
    ...
    <default field="typ_text" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="sonsttyp" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="sonsttyp_id" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="sonsttyp_text" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint field="typ" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="typ_text" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="sonsttyp" desc="" exp=""/>
    <constraint field="sonsttyp_id" desc="" exp=""/>
    <constraint field="sonsttyp_text" desc="" exp=""/>
    ...
    <constraint field="typ_text" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;ebene&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="sonsttyp_id" hidden="0"/>
      <column width="-1" type="field" name="sonsttyp_text" hidden="0"/>
      <column width="-1" type="field" name="startbedingung" hidden="0"/>
      <column width="-1" type="field" name="startbedingung_dt" hidden="0"/>
      <column width="-1" type="field" name="typ_text" hidden="0"/>
      ...
      <column width="-1" type="field" name="sonsttyp" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="sonsttyp"/>
    <field editable="1" name="sonsttyp_codespace"/>
    <field editable="1" name="sonsttyp_id"/>
    <field editable="1" name="sonsttyp_text"/>
    ...
    <field editable="1" name="typ_text"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="sonsttyp"/>
    <field labelOnTop="0" name="sonsttyp_codespace"/>
    <field labelOnTop="0" name="sonsttyp_id"/>
    <field labelOnTop="0" name="sonsttyp_text"/>
    ...
    <field labelOnTop="0" name="typ_text"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="sonsttyp"/>
    <field reuseLastValue="0" name="sonsttyp_codespace"/>
    <field reuseLastValue="0" name="sonsttyp_id"/>
    <field reuseLastValue="0" name="sonsttyp_text"/>
    ...
    <field reuseLastValue="0" name="typ_text"/>
