...
<qgis version="3.34.13-Prizren" minScale="100000000" labelsEnabled="0" simplifyAlgorithm="0" autoRefreshTime="0" autoRefreshMode="Disabled" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" symbologyReferenceScale="-1" simplifyLocal="1" simplifyDrawingHints="1" maxScale="0" readOnly="0" simplifyMaxScale="1" simplifyDrawingTol="1">
  <flags>
  ...
  <temporal endExpression="" mode="0" enabled="0" endField="" startField="" fixedDuration="0" durationField="ogc_fid" limitMode="0" startExpression="" durationUnit="min" accumulate="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation clamping="Terrain" symbology="Line" showMarkerSymbolInSurfacePlots="0" binding="Centroid" zscale="1" extrusion="0" respectLayerSymbol="1" type="IndividualFeatures" extrusionEnabled="0" zoffset="0">
    ...
    <profileLineSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{87057694-3da4-4705-a6b8-d8c055d04ea5}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="fill" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" pass="0" locked="0" id="{a0494e7f-6cbc-49c4-a747-d1378726bcdf}" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="marker" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{aac25bf9-0961-4aaa-96f1-3e3759c32f88}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 enableorderby="0" type="singleSymbol" forceraster="0" symbollevels="0" referencescale="-1">
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{84c1e512-15e8-474c-8d00-837855607793}" class="SimpleLine">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" frame_rate="10">
        ...
        <layer enabled="1" pass="0" locked="0" id="{219859bb-1d0a-46e3-a776-1b91a508f7a3}" class="SimpleLine">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penColor="#000000" enabled="0" spacingUnit="MM" minimumSize="0" rotationOffset="270" maxScaleDenominator="1e+08" penAlpha="255" spacing="5" barWidth="5" backgroundAlpha="255" height="15" lineSizeScale="3x:0,0,0,0,0,0" diagramOrientation="Up" spacingUnitScale="3x:0,0,0,0,0,0" sizeType="MM" scaleDependency="Area" penWidth="0" minScaleDenominator="0" backgroundColor="#ffffff" showAxis="1" sizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" opacity="1" width="15" lineSizeType="MM" direction="0" scaleBasedVisibility="0">
      <fontProperties bold="0" italic="0" strikethrough="0" style="" underline="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0"/>
      <axisSymbol>
        <symbol name="" alpha="1" force_rhr="0" is_animated="0" clip_to_extent="1" type="line" frame_rate="10">
          <data_defined_properties>
            <Option type="Map">
          ...
          <layer enabled="1" pass="0" locked="0" id="{c5b1e8c1-d822-488b-87db-9a3bc446b37c}" class="SimpleLine">
            <Option type="Map">
              <Option name="align_dash_pattern" value="0" type="QString"/>
              <Option name="capstyle" value="square" type="QString"/>
              <Option name="customdash" value="5;2" type="QString"/>
  ...
  <fieldConfiguration>
    ...
    <field name="sonstrechtscharakter_codespace" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="sonstrechtscharakter" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="artderfestlegung" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="detailartderfestlegung_codespace" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="detailartderfestlegung" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="istverdachtsflaeche" configurationFlags="NoFlag">
      <editWidget type="CheckBox">
        <config>
          <Option/>
        </config>
    ...
    <field name="xplan_name" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="nummer" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="istverdachtsflaeche" index="34"/>
  ...
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="gehoertzubereich_fp_bereich_pkid"/>
    ...
    <policy policy="Duplicate" field="sonstrechtscharakter_codespace"/>
    <policy policy="Duplicate" field="sonstrechtscharakter"/>
    ...
    <policy policy="Duplicate" field="artderfestlegung"/>
    <policy policy="Duplicate" field="detailartderfestlegung_codespace"/>
    <policy policy="Duplicate" field="detailartderfestlegung"/>
    <policy policy="Duplicate" field="istverdachtsflaeche"/>
    <policy policy="Duplicate" field="xplan_name"/>
    <policy policy="Duplicate" field="nummer"/>
  </splitPolicies>
  <defaults>
    ...
    <default field="istverdachtsflaeche" applyOnUpdate="0" expression=""/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" notnull_strength="1" field="id" constraints="1" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="description" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="descriptionreference_href" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="descriptionreference_title" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="descriptionreference_nilreason" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="identifier_codespace" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="identifier" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="uuid" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="text" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="rechtsstand" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gesetzlichegrundlage_codespace" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gesetzlichegrundlage" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gliederung1" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gliederung2" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="ebene" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gehoertzubereich_owns" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gehoertzubereich_href" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gehoertzubereich_title" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gehoertzubereich_nilreason" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="gehoertzubereich_fp_bereich_pkid" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="startbedingung_pkid" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="endebedingung_pkid" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="aufschrift" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="1" field="rechtscharakter" constraints="1" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="sonstrechtscharakter_codespace" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="sonstrechtscharakter" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="flaechenschluss" constraints="0" exp_strength="0"/>
    ...
    <constraint unique_strength="0" notnull_strength="0" field="artderfestlegung" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="detailartderfestlegung_codespace" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="detailartderfestlegung" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="istverdachtsflaeche" constraints="0" exp_strength="0"/>
    <constraint unique_strength="0" notnull_strength="0" field="xplan_name" constraints="0" exp_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="istverdachtsflaeche" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="1" actionWidgetStyle="dropDown" sortExpression="&quot;rechtscharakter&quot;">
    <columns>
      ...
      <column name="sonstrechtscharakter_codespace" hidden="0" type="field" width="-1"/>
      ...
      <column name="nordwinkel_uom" hidden="0" type="field" width="-1"/>
      <column name="nordwinkel" hidden="0" type="field" width="-1"/>
      <column name="artderfestlegung" hidden="0" type="field" width="-1"/>
      <column name="detailartderfestlegung_codespace" hidden="0" type="field" width="-1"/>
      <column name="detailartderfestlegung" hidden="0" type="field" width="-1"/>
      <column name="istverdachtsflaeche" hidden="0" type="field" width="-1"/>
      <column name="xplan_name" hidden="0" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="istverdachtsflaeche" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="istverdachtsflaeche" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="istverdachtsflaeche" reuseLastValue="0"/>
