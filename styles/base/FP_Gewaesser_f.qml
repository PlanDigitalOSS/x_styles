...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" version="3.22.7-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" maxScale="0">
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="fill" name="0">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="193,226,235,255" type="QString" name="color"/>
          ...
          <prop k="color" v="193,226,235,255"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="detailliertezweckbestimmung_id">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="detailliertezweckbestimmung_text">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="detailliertezweckbestimmung" index="4" name=""/>
    <alias field="detailliertezweckbestimmung_id" index="5" name=""/>
    <alias field="detailliertezweckbestimmung_text" index="6" name=""/>
    <alias field="ebene" index="7" name=""/>
    <alias field="endebedingung" index="8" name=""/>
    <alias field="endebedingung_dt" index="9" name=""/>
    <alias field="externereferenz" index="10" name=""/>
    <alias field="externereferenz_dt" index="11" name=""/>
    <alias field="flaechenschluss" index="12" name=""/>
    <alias field="flussrichtung" index="13" name=""/>
    <alias field="gehoertzubereich" index="14" name=""/>
    <alias field="gesetzlichegrundlage" index="15" name=""/>
    <alias field="gesetzlichegrundlage_id" index="16" name=""/>
    <alias field="gesetzlichegrundlage_text" index="17" name=""/>
    <alias field="gliederung1" index="18" name=""/>
    <alias field="gliederung2" index="19" name=""/>
    <alias field="gml_id" index="20" name=""/>
    <alias field="hatgenerattribut" index="21" name=""/>
    <alias field="hatgenerattribut_dt" index="22" name=""/>
    <alias field="hoehenangabe" index="23" name=""/>
    <alias field="hoehenangabe_dt" index="24" name=""/>
    <alias field="konvertierung_id" index="25" name=""/>
    <alias field="nordwinkel" index="26" name=""/>
    ...
    <alias field="spezifischepraegung" index="33" name=""/>
    <alias field="spezifischepraegung_id" index="34" name=""/>
    <alias field="spezifischepraegung_text" index="35" name=""/>
    <alias field="startbedingung" index="36" name=""/>
    <alias field="startbedingung_dt" index="37" name=""/>
    <alias field="text" index="38" name=""/>
    <alias field="updated_at" index="39" name=""/>
    <alias field="user_id" index="40" name=""/>
    <alias field="uuid" index="41" name=""/>
    <alias field="vongenehmigungausgenommen" index="42" name=""/>
    <alias field="wirdausgeglichendurchflaeche" index="43" name=""/>
    <alias field="wirdausgeglichendurchspe" index="44" name=""/>
    <alias field="wirddargestelltdurch" index="45" name=""/>
    <alias field="zweckbestimmung" index="46" name=""/>
    <alias field="zweckbestimmung_text" index="47" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="detailliertezweckbestimmung" expression="" applyOnUpdate="0"/>
    <default field="detailliertezweckbestimmung_id" expression="" applyOnUpdate="0"/>
    <default field="detailliertezweckbestimmung_text" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="detailliertezweckbestimmung" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="detailliertezweckbestimmung_id" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="detailliertezweckbestimmung_text" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="detailliertezweckbestimmung_id" desc="" exp=""/>
    <constraint field="detailliertezweckbestimmung_text" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="&quot;zweckbestimmung&quot;" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="detailliertezweckbestimmung" hidden="0"/>
      ...
      <column width="-1" type="field" name="detailliertezweckbestimmung_id" hidden="0"/>
      <column width="-1" type="field" name="detailliertezweckbestimmung_text" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="detailliertezweckbestimmung_id"/>
    <field editable="1" name="detailliertezweckbestimmung_text"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="detailliertezweckbestimmung_id"/>
    <field labelOnTop="0" name="detailliertezweckbestimmung_text"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="detailliertezweckbestimmung_id"/>
    <field reuseLastValue="0" name="detailliertezweckbestimmung_text"/>
