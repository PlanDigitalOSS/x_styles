...
<qgis minScale="100000000" labelsEnabled="1" simplifyDrawingHints="1" readOnly="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" maxScale="0" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyMaxScale="1" version="3.16.8-Hannover" simplifyLocal="1">
  <flags>
  ...
  <renderer-v2 forceraster="0" enableorderby="0" type="RuleRenderer" symbollevels="0">
    <rules key="{4ca0cb6c-8aff-44f5-b093-5abf8d2961cb}">
      <rule label="Bundesautobahn" filter="&quot;artderFestlegung&quot; = '1000'" key="{d75e9fbe-4583-41a1-a56e-6f107026cd18}" symbol="0"/>
      <rule label="Bundesstraße" filter="&quot;artderFestlegung&quot; = '1100'" key="{d75e9fbe-4583-41a1-a56e-6f107026cd18}" symbol="1"/>
      <rule label="Landes- oder Staatsstraße" filter="&quot;artderFestlegung&quot; = '1200'" key="{d75e9fbe-4583-41a1-a56e-6f107026cd18}" symbol="2"/>
      <rule label="Kreisstraße" filter="&quot;artderFestlegung&quot; = '1300'" key="{bf353e6f-dcf7-4ddc-a234-7ffd7312e909}" symbol="3"/>
      <rule label="Sonstige öffentliche Straße" filter="&quot;artderFestlegung&quot; = '9999'" key="{c6a93033-050c-47a9-826e-5ad2be6e8686}" symbol="4"/>
      <rule label="fehlend" filter="ELSE" key="{4aaf37eb-92be-4181-b18c-9b15113f53ef}" symbol="5"/>
    </rules>
    <symbols>
      ...
      <symbol clip_to_extent="1" alpha="1" force_rhr="0" name="4" type="line">
        ...
        <layer class="SimpleLine" pass="0" enabled="1" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="249,228,116,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="40"/>
          <prop k="line_width_unit" v="MapUnit"/>
          <prop k="offset" v="0"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOrientation="horizontal" fieldName="aufschrift" fontItalic="0" textOpacity="1" fontUnderline="0" allowHtml="0" fontSizeUnit="Point" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" fontSize="10" capitalization="0" fontKerning="1" textColor="0,0,0,255" fontWordSpacing="0" previewBkgrdColor="255,255,255,255" isExpression="0" useSubstitutions="0" fontWeight="50" fontLetterSpacing="0" blendMode="0" multilineHeight="1" fontFamily="MS Shell Dlg 2" namedStyle="Standard">
        <text-buffer bufferColor="255,255,255,255" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferJoinStyle="128" bufferSizeUnits="MM" bufferDraw="0" bufferNoFill="1"/>
        <text-mask maskSize="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers="" maskType="0" maskJoinStyle="128" maskEnabled="0" maskSizeUnits="MM" maskOpacity="1"/>
        <background shapeOffsetY="0" shapeRadiiUnit="MM" shapeBorderWidthUnit="MM" shapeSVGFile="" shapeSizeUnit="MM" shapeDraw="0" shapeFillColor="255,255,255,255" shapeRotationType="0" shapeOpacity="1" shapeBorderWidth="0" shapeJoinStyle="64" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetX="0" shapeSizeY="0" shapeRadiiX="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBorderColor="128,128,128,255" shapeSizeX="0" shapeSizeType="0" shapeRotation="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeOffsetUnit="MM" shapeRadiiY="0" shapeBlendMode="0" shapeType="0">
        ...
        <shadow shadowOffsetGlobal="1" shadowOpacity="0.69999999999999996" shadowDraw="0" shadowOffsetAngle="135" shadowOffsetDist="1" shadowColor="0,0,0,255" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowScale="100" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowBlendMode="6" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowUnder="0" shadowRadiusUnit="MM" shadowOffsetUnit="MM"/>
        <dd_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format reverseDirectionSymbol="0" formatNumbers="0" rightDirectionSymbol=">" useMaxLineLengthForAutoWrap="1" plussign="0" multilineAlign="0" autoWrapLength="0" decimals="3" wrapChar="" addDirectionSymbol="0" placeDirectionSymbol="0" leftDirectionSymbol="&lt;"/>
      <placement polygonPlacementFlags="2" maxCurvedCharAngleOut="-25" quadOffset="4" repeatDistanceUnits="MM" repeatDistance="0" yOffset="0" offsetUnits="MM" fitInPolygonOnly="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="0" rotationAngle="0" placement="3" overrunDistanceUnit="MM" geometryGeneratorEnabled="0" overrunDistance="0" dist="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" layerType="LineGeometry" centroidInside="0" maxCurvedCharAngleIn="25" placementFlags="10" preserveRotation="1" lineAnchorPercent="0.5" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" lineAnchorType="0" geometryGenerator="" geometryGeneratorType="PointGeometry" distUnits="MM" centroidWhole="0" xOffset="0" distMapUnitScale="3x:0,0,0,0,0,0" priority="5"/>
      <rendering scaleMin="0" fontMinPixelSize="3" upsidedownLabels="0" fontLimitPixelSize="0" mergeLines="0" displayAll="0" scaleMax="0" obstacleFactor="1" labelPerPart="0" zIndex="0" scaleVisibility="0" minFeatureSize="0" drawLabels="1" fontMaxPixelSize="10000" limitNumLabels="0" maxNumLabels="2000" obstacle="1" obstacleType="1"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory maxScaleDenominator="1e+08" penAlpha="255" backgroundAlpha="255" backgroundColor="#ffffff" height="15" lineSizeType="MM" minimumSize="0" showAxis="1" enabled="0" sizeType="MM" rotationOffset="270" spacing="5" minScaleDenominator="0" penColor="#000000" labelPlacementMethod="XHeight" width="15" penWidth="0" opacity="1" scaleDependency="Area" direction="0" barWidth="5" sizeScale="3x:0,0,0,0,0,0" scaleBasedVisibility="0" lineSizeScale="3x:0,0,0,0,0,0" spacingUnitScale="3x:0,0,0,0,0,0" spacingUnit="MM" diagramOrientation="Up">
  ...
  <DiagramLayerSettings priority="0" zIndex="0" showAll="1" linePlacementFlags="18" placement="2" dist="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias index="34" field="xplan_name" name=""/>
    <alias index="35" field="nummer" name=""/>
  </aliases>
  <defaults>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="&quot;zweckbestimmung&quot;">
    <columns>
      ...
      <column hidden="0" width="315" name="text" type="field"/>
      ...
      <column hidden="0" width="261" name="artderfestlegung" type="field"/>
