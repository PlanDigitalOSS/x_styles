...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" version="3.22.7-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" maxScale="0">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{0bd965e8-e555-497a-a081-ab1a2dd5ee7e}">
      <rule key="{2935891b-412d-48f6-a636-8bfc307a47e7}" symbol="0" label="Flaechen fuer Abgrabungen oder fuer die Gewinnung von Bodenschaetzen"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="fill" name="0">
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            <Option value="20" type="QString" name="average_angle_length"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="abbaugut">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="abbaugut" index="2" name=""/>
    <alias field="aufschrift" index="3" name=""/>
    <alias field="created_at" index="4" name=""/>
    <alias field="ebene" index="5" name=""/>
    <alias field="endebedingung" index="6" name=""/>
    <alias field="endebedingung_dt" index="7" name=""/>
    <alias field="externereferenz" index="8" name=""/>
    <alias field="externereferenz_dt" index="9" name=""/>
    <alias field="flaechenschluss" index="10" name=""/>
    <alias field="flussrichtung" index="11" name=""/>
    <alias field="gehoertzubereich" index="12" name=""/>
    <alias field="gesetzlichegrundlage" index="13" name=""/>
    <alias field="gesetzlichegrundlage_id" index="14" name=""/>
    <alias field="gesetzlichegrundlage_text" index="15" name=""/>
    <alias field="gliederung1" index="16" name=""/>
    <alias field="gliederung2" index="17" name=""/>
    <alias field="gml_id" index="18" name=""/>
    <alias field="hatgenerattribut" index="19" name=""/>
    <alias field="hatgenerattribut_dt" index="20" name=""/>
    <alias field="hoehenangabe" index="21" name=""/>
    <alias field="hoehenangabe_dt" index="22" name=""/>
    <alias field="konvertierung_id" index="23" name=""/>
    <alias field="nordwinkel" index="24" name=""/>
    <alias field="rechtscharakter" index="25" name=""/>
    <alias field="rechtscharakter_text" index="26" name=""/>
    <alias field="rechtsstand" index="27" name=""/>
    <alias field="rechtsstand_text" index="28" name=""/>
    <alias field="refbegruendunginhalt" index="29" name=""/>
    <alias field="reftextinhalt" index="30" name=""/>
    <alias field="spezifischepraegung" index="31" name=""/>
    <alias field="spezifischepraegung_id" index="32" name=""/>
    <alias field="spezifischepraegung_text" index="33" name=""/>
    ...
    <alias field="vongenehmigungausgenommen" index="40" name=""/>
    <alias field="wirdausgeglichendurchflaeche" index="41" name=""/>
    <alias field="wirdausgeglichendurchspe" index="42" name=""/>
    <alias field="wirddargestelltdurch" index="43" name=""/>
  </aliases>
  <defaults>
    <default field="plan_name" expression="" applyOnUpdate="0"/>
    <default field="stelle_id" expression="" applyOnUpdate="0"/>
    <default field="abbaugut" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint field="abbaugut" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint field="abbaugut" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="abbaugut" hidden="0"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="abbaugut"/>
  ...
  <labelOnTop>
    <field labelOnTop="0" name="abbaugut"/>
