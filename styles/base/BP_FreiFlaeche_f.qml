...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" version="3.22.7-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" maxScale="0">
  ...
  <aliases>
    ...
    <alias field="gehoertzubereich" index="10" name=""/>
    <alias field="gesetzlichegrundlage" index="11" name=""/>
    <alias field="gesetzlichegrundlage_id" index="12" name=""/>
    <alias field="gesetzlichegrundlage_text" index="13" name=""/>
    <alias field="gliederung1" index="14" name=""/>
    <alias field="gliederung2" index="15" name=""/>
    <alias field="gml_id" index="16" name=""/>
    <alias field="hatgenerattribut" index="17" name=""/>
    <alias field="hatgenerattribut_dt" index="18" name=""/>
    <alias field="hoehenangabe" index="19" name=""/>
    <alias field="hoehenangabe_dt" index="20" name=""/>
    <alias field="konvertierung_id" index="21" name=""/>
    <alias field="laermkontingent" index="22" name=""/>
    <alias field="laermkontingent_dt" index="23" name=""/>
    <alias field="laermkontingentgebiet" index="24" name=""/>
    <alias field="laermkontingentgebiet_dt" index="25" name=""/>
    <alias field="nutzung" index="26" name=""/>
    <alias field="rechtscharakter" index="27" name=""/>
    <alias field="rechtscharakter_text" index="28" name=""/>
    <alias field="rechtsstand" index="29" name=""/>
    <alias field="rechtsstand_text" index="30" name=""/>
    <alias field="refbegruendunginhalt" index="31" name=""/>
    <alias field="reftextinhalt" index="32" name=""/>
    <alias field="richtungssektorgrenze" index="33" name=""/>
    <alias field="startbedingung" index="34" name=""/>
    <alias field="startbedingung_dt" index="35" name=""/>
    <alias field="text" index="36" name=""/>
    <alias field="updated_at" index="37" name=""/>
    <alias field="user_id" index="38" name=""/>
    <alias field="uuid" index="39" name=""/>
    <alias field="wirdausgeglichendurchabe" index="40" name=""/>
    <alias field="wirdausgeglichendurchflaeche" index="41" name=""/>
    <alias field="wirdausgeglichendurchmassnahme" index="42" name=""/>
    <alias field="wirdausgeglichendurchspeflaeche" index="43" name=""/>
    <alias field="wirdausgeglichendurchspemassnahme" index="44" name=""/>
    <alias field="wirddargestelltdurch" index="45" name=""/>
    <alias field="zusatzkontingent" index="46" name=""/>
    <alias field="zusatzkontingentflaeche" index="47" name=""/>
  </aliases>
  <defaults>
  ...
  <constraints>
    ...
    <constraint field="nutzung" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="nutzung" hidden="0"/>
