...
<qgis hasScaleBasedVisibilityFlag="0" maxScale="0" labelsEnabled="0" symbologyReferenceScale="-1" version="3.22.7-Białowieża" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" simplifyDrawingTol="1" readOnly="0" minScale="100000000" simplifyDrawingHints="1" simplifyMaxScale="1">
  <flags>
  ...
  <temporal mode="0" enabled="0" startField="" fixedDuration="0" endField="" endExpression="" accumulate="0" startExpression="" durationField="" durationUnit="min" limitMode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <renderer-v2 referencescale="-1" type="RuleRenderer" symbollevels="0" enableorderby="0" forceraster="0">
    <rules key="{3dd294cf-533a-4d53-b13c-1464787cbfc8}">
      <rule symbol="0" key="{6b3b9a48-a11d-4cb9-869a-42cb4ddf9519}" label="Aufschüttung -bestehend-" filter=" &quot;rechtscharakter&quot;  =  2000 "/>
      <rule symbol="1" key="{81d8e5f7-b32e-40ba-b477-44fe9f69c313}" label="Aufschüttung -geplant-" filter=" &quot;rechtscharakter&quot;  =  1000 "/>
      <rule symbol="2" key="{475ad858-f999-48d9-b1e4-ac2bf0406d6d}" label="Aufschüttung -Kennzeichnung-" filter=" &quot;rechtscharakter&quot;  =  5000 "/>
      <rule symbol="3" key="{a06dcbb9-1476-4959-b5c7-796a750af37c}" filter="ELSE"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" name="0" type="fill" alpha="1" clip_to_extent="1">
        ...
        <layer class="MarkerLine" enabled="1" locked="0" pass="0">
          ...
          <prop k="average_angle_length" v="20"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory penWidth="0" maxScaleDenominator="1e+08" spacingUnitScale="3x:0,0,0,0,0,0" spacingUnit="MM" sizeType="MM" minScaleDenominator="0" enabled="0" lineSizeType="MM" minimumSize="0" scaleBasedVisibility="0" backgroundAlpha="255" barWidth="5" rotationOffset="270" showAxis="1" scaleDependency="Area" diagramOrientation="Up" height="15" penAlpha="255" spacing="5" penColor="#000000" labelPlacementMethod="XHeight" width="15" opacity="1" direction="0" lineSizeScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" sizeScale="3x:0,0,0,0,0,0">
  ...
  <DiagramLayerSettings priority="0" dist="0" zIndex="0" showAll="1" obstacle="0" placement="1" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="aufschuettungsmaterial" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="aufschuettungsmaterial" name="" index="31"/>
  </aliases>
  <defaults>
    ...
    <default expression="" field="aufschuettungsmaterial" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint field="ogc_fid" exp_strength="0" unique_strength="1" notnull_strength="1" constraints="3"/>
    <constraint field="id" exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1"/>
    <constraint field="description" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="descriptionreference_href" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="descriptionreference_title" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="descriptionreference_nilreason" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="identifier_codespace" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="identifier" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="uuid" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="text" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="rechtsstand" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gesetzlichegrundlage_codespace" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gesetzlichegrundlage" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gliederung1" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gliederung2" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="ebene" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_owns" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_href" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_title" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_nilreason" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="gehoertzubereich_fp_bereich_pkid" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="startbedingung_pkid" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="endebedingung_pkid" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="aufschrift" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="rechtscharakter" exp_strength="0" unique_strength="0" notnull_strength="1" constraints="1"/>
    <constraint field="spezifischepraegung_codespace" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="spezifischepraegung" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="flaechenschluss" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="flussrichtung" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="nordwinkel_uom" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="nordwinkel" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
    <constraint field="aufschuettungsmaterial" exp_strength="0" unique_strength="0" notnull_strength="0" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig sortExpression="&quot;rechtscharakter&quot;" actionWidgetStyle="dropDown" sortOrder="1">
    <columns>
      ...
      <column name="aufschuettungsmaterial" type="field" hidden="0" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="aufschuettungsmaterial"/>
