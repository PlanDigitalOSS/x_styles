...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" version="3.22.7-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" maxScale="0">
  ...
  <renderer-v2 forceraster="0" referencescale="-1" symbollevels="0" enableorderby="0" type="RuleRenderer">
    <rules key="{10984706-7e8d-4aa4-ba7e-8d1a3c563ef9}">
      <rule filter=" &quot;zweckbestimmung&quot; ILIKE '%ohne%'" key="{c34e02d0-30fe-4f89-84b6-5b385f8c206b}" symbol="0" label="Fläche ohne Darstellung"/>
      <rule filter="ELSE" key="{855018bc-75a0-4bfb-a04c-c0d545aa4d75}" symbol="1" label="sonstige Darstellung"/>
    </rules>
    <symbols>
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="fill" name="0">
        ...
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="251,234,216,255" type="QString" name="color"/>
            <Option value="bevel" type="QString" name="joinstyle"/>
            <Option value="0,0" type="QString" name="offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="offset_map_unit_scale"/>
            <Option value="MapUnit" type="QString" name="offset_unit"/>
            <Option value="251,234,216,255" type="QString" name="outline_color"/>
          ...
          <prop k="color" v="251,234,216,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MapUnit"/>
          <prop k="outline_color" v="251,234,216,255"/>
  ...
  <aliases>
    ...
    <alias field="nordwinkel" index="23" name=""/>
    <alias field="rechtscharakter" index="24" name=""/>
    <alias field="rechtscharakter_text" index="25" name=""/>
    <alias field="rechtsstand" index="26" name=""/>
    <alias field="rechtsstand_text" index="27" name=""/>
    <alias field="refbegruendunginhalt" index="28" name=""/>
    <alias field="reftextinhalt" index="29" name=""/>
    <alias field="spezifischepraegung" index="30" name=""/>
    <alias field="spezifischepraegung_id" index="31" name=""/>
    <alias field="spezifischepraegung_text" index="32" name=""/>
    <alias field="startbedingung" index="33" name=""/>
    <alias field="startbedingung_dt" index="34" name=""/>
    <alias field="text" index="35" name=""/>
    <alias field="updated_at" index="36" name=""/>
    <alias field="user_id" index="37" name=""/>
    <alias field="uuid" index="38" name=""/>
    <alias field="vongenehmigungausgenommen" index="39" name=""/>
    <alias field="wirdausgeglichendurchflaeche" index="40" name=""/>
    <alias field="wirdausgeglichendurchspe" index="41" name=""/>
    <alias field="wirddargestelltdurch" index="42" name=""/>
    <alias field="zweckbestimmung" index="43" name=""/>
    <alias field="zweckbestimmung_id" index="44" name=""/>
    <alias field="zweckbestimmung_text" index="45" name=""/>
  </aliases>
  <defaults>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      <column width="816" type="field" name="text" hidden="0"/>
