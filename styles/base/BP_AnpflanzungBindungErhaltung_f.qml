...
<qgis hasScaleBasedVisibilityFlag="0" simplifyDrawingHints="1" simplifyDrawingTol="1" labelsEnabled="0" symbologyReferenceScale="-1" readOnly="0" styleCategories="AllStyleCategories" version="3.22.7-Białowieża" minScale="100000000" simplifyAlgorithm="0" simplifyLocal="1" simplifyMaxScale="1" maxScale="0">
      ...
      <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="fill" name="0">
        ...
        <layer class="SVGFill" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="" type="QString" name="data"/>
          ...
          <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="line" name="@0@0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleLine" enabled="1" pass="0" locked="0">
              <Option type="Map">
                ...
                <Option value="42,227,86,255" type="QString" name="line_color"/>
              ...
              <prop k="line_color" v="42,227,86,255"/>
        ...
        <layer class="SVGFill" enabled="1" pass="0" locked="0">
          ...
          <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="line" name="@0@1">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
        ...
        <layer class="MarkerLine" enabled="1" pass="0" locked="0">
          <Option type="Map">
            ...
            <Option value="0" type="QString" name="offset"/>
            <Option value="0.8" type="QString" name="offset_along_line"/>
          ...
          <symbol force_rhr="0" alpha="1" clip_to_extent="1" type="marker" name="@0@2">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" type="QString" name="name"/>
                <Option name="properties"/>
            ...
            <layer class="SimpleMarker" enabled="1" pass="0" locked="0">
              <Option type="Map">
                ...
                <Option value="42,227,86,255" type="QString" name="color"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="baumart_id">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="baumart_text">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="gegenstand_text">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="inverszu_wirdausgeglichendurchabe_bp_objekt">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="laermkontingent_dt">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="laermkontingentgebiet_dt">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="None" name="massnahme_text">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="anzahl" index="2" name=""/>
    <alias field="aufschrift" index="3" name=""/>
    <alias field="baumart" index="4" name=""/>
    <alias field="baumart_id" index="5" name=""/>
    <alias field="baumart_text" index="6" name=""/>
    <alias field="created_at" index="7" name=""/>
    <alias field="ebene" index="8" name=""/>
    <alias field="endebedingung" index="9" name=""/>
    <alias field="endebedingung_dt" index="10" name=""/>
    <alias field="externereferenz" index="11" name=""/>
    <alias field="externereferenz_dt" index="12" name=""/>
    <alias field="flaechenschluss" index="13" name=""/>
    <alias field="flussrichtung" index="14" name=""/>
    <alias field="gegenstand" index="15" name=""/>
    <alias field="gegenstand_text" index="16" name=""/>
    <alias field="gehoertzubereich" index="17" name=""/>
    <alias field="gesetzlichegrundlage" index="18" name=""/>
    <alias field="gesetzlichegrundlage_id" index="19" name=""/>
    <alias field="gesetzlichegrundlage_text" index="20" name=""/>
    <alias field="gliederung1" index="21" name=""/>
    <alias field="gliederung2" index="22" name=""/>
    <alias field="gml_id" index="23" name=""/>
    <alias field="hatgenerattribut" index="24" name=""/>
    <alias field="hatgenerattribut_dt" index="25" name=""/>
    <alias field="hoehenangabe" index="26" name=""/>
    <alias field="hoehenangabe_dt" index="27" name=""/>
    <alias field="inverszu_wirdausgeglichendurchabe_bp_objekt" index="28" name=""/>
    <alias field="istausgleich" index="29" name=""/>
    <alias field="konvertierung_id" index="30" name=""/>
    <alias field="kronendurchmesser" index="31" name=""/>
    <alias field="laermkontingent" index="32" name=""/>
    <alias field="laermkontingent_dt" index="33" name=""/>
    <alias field="laermkontingentgebiet" index="34" name=""/>
    <alias field="laermkontingentgebiet_dt" index="35" name=""/>
    <alias field="massnahme" index="36" name=""/>
    <alias field="massnahme_text" index="37" name=""/>
    <alias field="mindesthoehe" index="38" name=""/>
    <alias field="nordwinkel" index="39" name=""/>
    <alias field="pflanztiefe" index="40" name=""/>
    <alias field="rechtscharakter" index="41" name=""/>
    <alias field="rechtscharakter_text" index="42" name=""/>
    <alias field="rechtsstand" index="43" name=""/>
    <alias field="rechtsstand_text" index="44" name=""/>
    <alias field="refbegruendunginhalt" index="45" name=""/>
    <alias field="reftextinhalt" index="46" name=""/>
    <alias field="richtungssektorgrenze" index="47" name=""/>
    <alias field="startbedingung" index="48" name=""/>
    <alias field="startbedingung_dt" index="49" name=""/>
    <alias field="text" index="50" name=""/>
    <alias field="updated_at" index="51" name=""/>
    <alias field="user_id" index="52" name=""/>
    <alias field="uuid" index="53" name=""/>
    <alias field="wirdausgeglichendurchabe" index="54" name=""/>
    <alias field="wirdausgeglichendurchflaeche" index="55" name=""/>
    <alias field="wirdausgeglichendurchmassnahme" index="56" name=""/>
    <alias field="wirdausgeglichendurchspeflaeche" index="57" name=""/>
    <alias field="wirdausgeglichendurchspemassnahme" index="58" name=""/>
    <alias field="wirddargestelltdurch" index="59" name=""/>
    <alias field="zusatzkontingent" index="60" name=""/>
    <alias field="zusatzkontingentflaeche" index="61" name=""/>
  </aliases>
  <defaults>
    ...
    <default field="baumart" expression="" applyOnUpdate="0"/>
    <default field="baumart_id" expression="" applyOnUpdate="0"/>
    <default field="baumart_text" expression="" applyOnUpdate="0"/>
    ...
    <default field="gegenstand" expression="" applyOnUpdate="0"/>
    <default field="gegenstand_text" expression="" applyOnUpdate="0"/>
    ...
    <default field="inverszu_wirdausgeglichendurchabe_bp_objekt" expression="" applyOnUpdate="0"/>
    <default field="istausgleich" expression="" applyOnUpdate="0"/>
    <default field="konvertierung_id" expression="" applyOnUpdate="0"/>
    <default field="kronendurchmesser" expression="" applyOnUpdate="0"/>
    <default field="laermkontingent" expression="" applyOnUpdate="0"/>
    <default field="laermkontingent_dt" expression="" applyOnUpdate="0"/>
    <default field="laermkontingentgebiet" expression="" applyOnUpdate="0"/>
    <default field="laermkontingentgebiet_dt" expression="" applyOnUpdate="0"/>
    <default field="massnahme" expression="" applyOnUpdate="0"/>
    <default field="massnahme_text" expression="" applyOnUpdate="0"/>
    <default field="mindesthoehe" expression="" applyOnUpdate="0"/>
    <default field="nordwinkel" expression="" applyOnUpdate="0"/>
    <default field="pflanztiefe" expression="" applyOnUpdate="0"/>
    ...
    <default field="richtungssektorgrenze" expression="" applyOnUpdate="0"/>
    ...
    <default field="wirdausgeglichendurchabe" expression="" applyOnUpdate="0"/>
    <default field="wirdausgeglichendurchflaeche" expression="" applyOnUpdate="0"/>
    <default field="wirdausgeglichendurchmassnahme" expression="" applyOnUpdate="0"/>
    <default field="wirdausgeglichendurchspeflaeche" expression="" applyOnUpdate="0"/>
    <default field="wirdausgeglichendurchspemassnahme" expression="" applyOnUpdate="0"/>
    <default field="wirddargestelltdurch" expression="" applyOnUpdate="0"/>
    <default field="zusatzkontingent" expression="" applyOnUpdate="0"/>
    <default field="zusatzkontingentflaeche" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    ...
    <constraint field="anzahl" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="aufschrift" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="baumart" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="baumart_id" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="baumart_text" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint field="flaechenschluss" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="flussrichtung" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="gegenstand" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="gegenstand_text" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint field="inverszu_wirdausgeglichendurchabe_bp_objekt" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="istausgleich" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="konvertierung_id" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="kronendurchmesser" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="laermkontingent" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="laermkontingent_dt" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="laermkontingentgebiet" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="laermkontingentgebiet_dt" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="massnahme" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="massnahme_text" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="mindesthoehe" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="nordwinkel" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="pflanztiefe" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint field="richtungssektorgrenze" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint field="wirdausgeglichendurchabe" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="wirdausgeglichendurchflaeche" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="wirdausgeglichendurchmassnahme" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="wirdausgeglichendurchspeflaeche" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="wirdausgeglichendurchspemassnahme" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="wirddargestelltdurch" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="zusatzkontingent" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
    <constraint field="zusatzkontingentflaeche" constraints="0" unique_strength="0" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="plan_name" desc="" exp=""/>
    <constraint field="stelle_id" desc="" exp=""/>
    <constraint field="anzahl" desc="" exp=""/>
    <constraint field="aufschrift" desc="" exp=""/>
    <constraint field="baumart" desc="" exp=""/>
    <constraint field="baumart_id" desc="" exp=""/>
    <constraint field="baumart_text" desc="" exp=""/>
    ...
    <constraint field="gegenstand" desc="" exp=""/>
    <constraint field="gegenstand_text" desc="" exp=""/>
    ...
    <constraint field="inverszu_wirdausgeglichendurchabe_bp_objekt" desc="" exp=""/>
    <constraint field="istausgleich" desc="" exp=""/>
    <constraint field="konvertierung_id" desc="" exp=""/>
    <constraint field="kronendurchmesser" desc="" exp=""/>
    <constraint field="laermkontingent" desc="" exp=""/>
    <constraint field="laermkontingent_dt" desc="" exp=""/>
    <constraint field="laermkontingentgebiet" desc="" exp=""/>
    <constraint field="laermkontingentgebiet_dt" desc="" exp=""/>
    <constraint field="massnahme" desc="" exp=""/>
    <constraint field="massnahme_text" desc="" exp=""/>
    <constraint field="mindesthoehe" desc="" exp=""/>
    <constraint field="nordwinkel" desc="" exp=""/>
    <constraint field="pflanztiefe" desc="" exp=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" type="field" name="massnahme" hidden="0"/>
      ...
      <column width="-1" type="field" name="kronendurchmesser" hidden="0"/>
      <column width="-1" type="field" name="pflanztiefe" hidden="0"/>
      <column width="-1" type="field" name="istausgleich" hidden="0"/>
      <column width="-1" type="field" name="baumart" hidden="0"/>
      <column width="-1" type="field" name="mindesthoehe" hidden="0"/>
      <column width="-1" type="field" name="anzahl" hidden="0"/>
      <column width="-1" type="field" name="plan_name" hidden="0"/>
      <column width="-1" type="field" name="stelle_id" hidden="0"/>
      <column width="-1" type="field" name="baumart_id" hidden="0"/>
      <column width="-1" type="field" name="baumart_text" hidden="0"/>
      ...
      <column width="-1" type="field" name="gegenstand_text" hidden="0"/>
      ...
      <column width="-1" type="field" name="inverszu_wirdausgeglichendurchabe_bp_objekt" hidden="0"/>
      <column width="-1" type="field" name="konvertierung_id" hidden="0"/>
      <column width="-1" type="field" name="laermkontingent" hidden="0"/>
      <column width="-1" type="field" name="laermkontingent_dt" hidden="0"/>
      <column width="-1" type="field" name="laermkontingentgebiet" hidden="0"/>
      <column width="-1" type="field" name="laermkontingentgebiet_dt" hidden="0"/>
      <column width="-1" type="field" name="massnahme_text" hidden="0"/>
      ...
      <column width="-1" type="field" name="richtungssektorgrenze" hidden="0"/>
      ...
      <column width="-1" type="field" name="wirdausgeglichendurchabe" hidden="0"/>
      <column width="-1" type="field" name="wirdausgeglichendurchflaeche" hidden="0"/>
      <column width="-1" type="field" name="wirdausgeglichendurchmassnahme" hidden="0"/>
      <column width="-1" type="field" name="wirdausgeglichendurchspeflaeche" hidden="0"/>
      <column width="-1" type="field" name="wirdausgeglichendurchspemassnahme" hidden="0"/>
      <column width="-1" type="field" name="wirddargestelltdurch" hidden="0"/>
      <column width="-1" type="field" name="zusatzkontingent" hidden="0"/>
      <column width="-1" type="field" name="zusatzkontingentflaeche" hidden="0"/>
      <column width="-1" type="field" name="gegenstand" hidden="0"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field editable="1" name="baumart_id"/>
    <field editable="1" name="baumart_text"/>
    ...
    <field editable="1" name="gegenstand_text"/>
    ...
    <field editable="1" name="inverszu_wirdausgeglichendurchabe_bp_objekt"/>
    ...
    <field editable="1" name="laermkontingent_dt"/>
    <field editable="1" name="laermkontingentgebiet"/>
    <field editable="1" name="laermkontingentgebiet_dt"/>
    <field editable="1" name="massnahme"/>
    <field editable="1" name="massnahme_text"/>
  ...
  <labelOnTop>
    ...
    <field labelOnTop="0" name="baumart_codespace"/>
    <field labelOnTop="0" name="baumart_id"/>
    <field labelOnTop="0" name="baumart_text"/>
    ...
    <field labelOnTop="0" name="gegenstand_text"/>
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="baumart_id"/>
    <field reuseLastValue="0" name="baumart_text"/>
    ...
    <field reuseLastValue="0" name="gegenstand_text"/>
    ...
    <field reuseLastValue="0" name="inverszu_wirdausgeglichendurchabe_bp_objekt"/>
    ...
    <field reuseLastValue="0" name="laermkontingent_dt"/>
    <field reuseLastValue="0" name="laermkontingentgebiet"/>
    <field reuseLastValue="0" name="laermkontingentgebiet_dt"/>
    <field reuseLastValue="0" name="massnahme"/>
    <field reuseLastValue="0" name="massnahme_text"/>
