...
<qgis simplifyAlgorithm="0" autoRefreshMode="Disabled" simplifyMaxScale="1" readOnly="0" simplifyLocal="1" simplifyDrawingTol="1" maxScale="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" version="3.34.13-Prizren" minScale="100000000" autoRefreshTime="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" styleCategories="AllStyleCategories">
  <flags>
  ...
  <temporal accumulate="0" mode="0" limitMode="0" durationField="fid" endField="" startExpression="" endExpression="" durationUnit="min" enabled="0" startField="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation clamping="Terrain" type="IndividualFeatures" showMarkerSymbolInSurfacePlots="0" zoffset="0" zscale="1" respectLayerSymbol="1" extrusionEnabled="0" binding="Centroid" symbology="Line" extrusion="0">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" alpha="1" type="line" frame_rate="10" is_animated="0">
        ...
        <layer locked="0" class="SimpleLine" id="{5fd2696c-ab09-4665-a552-8fd61dbb03aa}" pass="0" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" alpha="1" type="fill" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleFill" id="{ea766512-7ee4-41d2-ad4d-4ed302fc8408}" pass="0" enabled="1">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" alpha="1" type="marker" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleMarker" id="{2948d0b3-53a6-44f2-a988-4c09ce92ccf2}" pass="0" enabled="1">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" forceraster="0" enableorderby="0" type="singleSymbol" referencescale="-1">
    <symbols>
      <symbol clip_to_extent="1" name="0" force_rhr="0" alpha="1" type="fill" frame_rate="10" is_animated="0">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
        ...
        <layer locked="0" class="SimpleFill" id="{d6b81bdc-ac22-4cd2-8128-b94dba82a3e9}" pass="0" enabled="1">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" name="" force_rhr="0" alpha="1" type="fill" frame_rate="10" is_animated="0">
        ...
        <layer locked="0" class="SimpleFill" id="{2d744b7c-5a23-4840-b5fe-3f9a34f76c42}" pass="0" enabled="1">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory diagramOrientation="Up" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" barWidth="5" lineSizeType="MM" spacing="5" penWidth="0" spacingUnitScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" opacity="1" direction="0" minScaleDenominator="0" enabled="0" sizeType="MM" penAlpha="255" scaleBasedVisibility="0" spacingUnit="MM" height="15" width="15" penColor="#000000" showAxis="1" sizeScale="3x:0,0,0,0,0,0" minimumSize="0" backgroundColor="#ffffff" scaleDependency="Area" backgroundAlpha="255" rotationOffset="270">
      <fontProperties strikethrough="0" bold="0" style="" italic="0" description="MS Shell Dlg 2,7.8,-1,5,50,0,0,0,0,0" underline="0"/>
      <axisSymbol>
        <symbol clip_to_extent="1" name="" force_rhr="0" alpha="1" type="line" frame_rate="10" is_animated="0">
          <data_defined_properties>
            <Option type="Map">
          ...
          <layer locked="0" class="SimpleLine" id="{01a7259a-9967-4e17-ba00-7d55b44cdeed}" pass="0" enabled="1">
            <Option type="Map">
              <Option name="align_dash_pattern" type="QString" value="0"/>
              <Option name="capstyle" type="QString" value="square"/>
              <Option name="customdash" type="QString" value="5;2"/>
  ...
  <DiagramLayerSettings dist="0" linePlacementFlags="18" obstacle="0" priority="0" placement="1" showAll="1" zIndex="0">
    <properties>
      <Option type="Map">
        <Option name="name" type="QString" value=""/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="gehoertzubereich_rp_bereich_pkid" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="konkretisierung" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="bedeutsamkeit" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field name="istzweckbindung" configurationFlags="NoFlag">
      <editWidget type="CheckBox">
        <config>
          <Option/>
        </config>
    ...
    <field name="besonderertyp" configurationFlags="NoFlag">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias name="" field="besonderertyp" index="32"/>
    <alias name="" field="typ" index="33"/>
  </aliases>
  <splitPolicies>
    ...
    <policy policy="Duplicate" field="besonderertyp"/>
  ...
  <defaults>
    ...
    <default field="besonderertyp" expression="" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint constraints="1" field="id" exp_strength="0" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" field="description" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="descriptionreference_href" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="descriptionreference_title" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="descriptionreference_nilreason" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="identifier_codespace" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="identifier" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="uuid" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="text" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="rechtsstand" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gesetzlichegrundlage_codespace" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gesetzlichegrundlage" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gliederung1" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gliederung2" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="ebene" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gehoertzubereich_owns" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gehoertzubereich_href" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gehoertzubereich_title" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gehoertzubereich_nilreason" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gehoertzubereich_rp_bereich_pkid" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="startbedingung_pkid" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="endebedingung_pkid" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="aufschrift" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="1" field="rechtscharakter" exp_strength="0" notnull_strength="1" unique_strength="0"/>
    <constraint constraints="0" field="konkretisierung" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="gebietstyp" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="kuestenmeer" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="bedeutsamkeit" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="istzweckbindung" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="flaechenschluss" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="flussrichtung" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="besonderertyp" exp_strength="0" notnull_strength="0" unique_strength="0"/>
    <constraint constraints="0" field="typ" exp_strength="0" notnull_strength="0" unique_strength="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint desc="" field="besonderertyp" exp=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="besonderertyp" hidden="0" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field name="besonderertyp" reuseLastValue="0"/>
